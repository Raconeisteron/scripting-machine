...
#Region "Enums"
    ...
    Public Enum VehType As Integer
        Airplane
        Helicopter
        Bike
        Convertible
...
#Region "Structures"
    ...
    Public Structure Cfg
        ...
        Public ZoneCreate As String
        Public ZoneShow As String
        Public oPath As String
        Public Bounds As String
    End Structure
...
#Region "Config"
    ...
    Public Sub LoadConfig()
        ...
        With Config
            ...
            .C_Area.Hex = Color.FromArgb(IniRead(Path, "AreaC", Color.FromArgb(166, 255, 0, 0).ToArgb))
            ...
            .URL_Sprite = IniRead(Path, "spURL", "")
            .ZoneCreate = IniRead(Path, "zcrte", "GangZoneCreate({0}, {1}, {2}, {3});")
            .ZoneShow = IniRead(Path, "zshw", "GangZoneShowForAll({5}, {6});")
            .A_Fill = IntToBool(IniRead(Path, "aFill", 0))
            .A_MSelect = IntToBool(IniRead(Path, "aMSelect", 0))
            .oPath = IniRead(Path, "oPath", My.Application.Info.DirectoryPath)
            .Bounds = IniRead(Path, "Bounds", "SetPlayerWorldBounds(playerid, {0}, {1}, {2}, {3});")
            ChangeLang(.Idioma)
            Select Case .Idioma
                Case Lang.English
        ...
        With Main
            ...
            .CheckBox8.Checked = Config.A_MSelect
            .CheckBox10.Checked = Config.A_Fill
    ...
    Public Sub SaveConfig()
        ...
        With Config
            ...
            IniWrite(Path, "AreaC", .C_Area.Hex.ToArgb())
            IniWrite(Path, "Lang", LanguajeToInt(.Idioma))
            IniWrite(Path, "dImg", Convert.ToInt16(.Images))
            IniWrite(Path, "zcrte", .ZoneCreate)
            IniWrite(Path, "zshw", .ZoneShow)
            IniWrite(Path, "aFill", BoolToInt(.A_Fill))
            IniWrite(Path, "aMSelect", BoolToInt(.A_MSelect))
            If .Images = True Then
                IniDelete(Path, "sURL")
                IniDelete(Path, "vURL")
                IniDelete(Path, "wURL")
                IniDelete(Path, "mURL")
                IniDelete(Path, "spURL")
            Else
                IniWrite(Path, "sURL", .URL_Skin)
                IniWrite(Path, "vURL", .URL_Veh)
                IniWrite(Path, "wURL", .URL_Weap)
                IniWrite(Path, "mURL", .URL_Map)
                IniWrite(Path, "spURL", .URL_Sprite)
            End If
            IniWrite(Path, "oPath", .oPath)
            IniWrite(Path, "Bounds", .Bounds)
        End With
    End Sub
        ...
        Select Case Idioma
            ...
            Case Else
                With Main
                    ...
                    .OtherToolStripMenuItem.Text = "Extras"
                    .CloseToolStripMenuItem.Text = "Schließen"
                    .CreditsToolStripMenuItem1.Text = "Credits"
                    .WebPageToolStripMenuItem.Text = "Internetseite"
                    .ForumToolStripMenuItem.Text = "Forum"
                    .MainPageToolStripMenuItem.Text = "Hauptseite"
                    .SearchForToolStripMenuItem.Text = "Suchen"
                    .TabPage2.Text = "Tore"
                    .TabPage5.Text = "Farbpalette"
                    .TabPage12.Text = "Einstellungen"
                    .Label2.Text = "Befehl:"
                    .GroupBox1.Text = "Typ"
                    .RadioButton1.Text = "Nur Spieler"
                    .RadioButton2.Text = "Spieler und Fahrzeug"
                    .GroupBox4.Text = "Befehlsprozessor:"
                    ...
                    .Label8.Text = "Welt:"
                    .Label8.Left = 309
                    .CheckBox1.Text = "Nachricht senden"
                    .Label3.Text = "Nachricht:"
                    .Label21.Text = "Hilfsnachricht"
                    .Label4.Text = "Nachricht:"
                    .Button1.Text = "Generieren"
                    .GroupBox5.Text = "Typ"
                    .RadioButton7.Text = "Torbefehl (verschiedene Befehle)"
                    .RadioButton10.Text = "Torbefehl (selber Befehl)"
                    .RadioButton8.Text = "Semiautomatisches Tor (nur öffnen)"
                    .RadioButton9.Text = "Vollautomatisches Tor"
                    .Label22.Text = "Befehl (öffnen):"
                    .Label23.Text = "Befehl (schließen):"
                    .CheckBox4.Text = "Dies ist ein Filterscript"
                    .Label27.Text = "Code:"
                    .GroupBox7.Text = "Konfiguration (Öffnen)"
                    .GroupBox8.Text = "Konfiguration (Schließen)"
                    .CheckBox2.Text = "Nachricht (Öffnen):"
                    .Label25.Text = "Nachricht:"
                    .CheckBox3.Text = "Nachricht (Schließen):"
                    .Label26.Text = "Nachricht:"
                    .Label28.Text = "Geschwindigkeit:"
                    .Label28.Left = 236
                    .Label29.Text = "Zeit zum Schließen (ms):"
                    .Label29.Left = 389
                    .Button4.Text = "Generieren"
                    .LinkLabel1.Text = "Model:"
                    .Label32.Text = "Welt:"
                    .Label34.Text = "Typ:"
                    .CheckBox5.Text = "Dies ist ein Filterscript"
                    .Button7.Text = "Generieren"
                    .Label37.Text = "Dialog ID:"
                    .Label39.Text = "Titel:"
                    .Label39.Left = 167
                    .Label38.Text = "Typ:"
                    .Label40.Text = "Text:"
                    .Label41.Text = "Knopf 1:"
                    .Label42.Text = "Knopf 2:"
                    .Button9.Text = "Vorschau"
                    ...
                    .CheckBox6.Text = "Farbe definieren"
                    .CheckBox8.Text = "Mehrere Gebiete"
                    .CheckBox10.Text = "Gebiete auffüllen"
                    .Button17.Text = "Gebiete löschen"
                    .Button16.Text = "Zurücksetzen"
                    .Button15.Text = "Exportieren"
                    .Label61.Text = "Objekte:"
                    .CheckBox9.Text = "Objekt ID fixen"
                    .Button14.Text = "Konvertieren"
                    .TabPage8.Text = "Fahrzeuge"
                    .TabPage9.Text = "Sounds"
                    .TabPage11.Text = "Waffen"
                    .TabPage14.Text = "Kartensymbole"
                    .Label73.Text = "Name:"
                    .Label73.Left = 205
                    ...
                    .Label71.Text = "Typ:"
                    .Label80.Text = "Define:"
                    .Label78.Text = "Kartensymbol:"
                    .Label76.Text = "Name:"
                    .Label76.Left = 235
                    .GroupBox10.Text = "Sprache"
                    .GroupBox12.Text = "Bilder"
                    .CheckBox7.Text = "Benutzerdefinierte Bilder verwenden"
                    .GroupBox14.Text = "Fahrzeug URL"
                    .GroupBox17.Text = "Waffen URL"
                    .GroupBox11.Text = "Symbol URL"
                    .GroupBox18.Text = "Gebiet"
                    .Label66.Text = "Format erstellen:"
                    .TextBox63.Left = 98
                    .TextBox63.Width = 545
                    .Button13.Text = "Standard"
                    .Button11.Text = "Annehmen"
                    .Button10.Text = "Abbrechen"
            ...
            While istart > -1 And iend > -1
                ...
                Else
                    Select Case Config.Idioma
                        Case Lang.English
                            MsgBox("The color must be in RGB Hex code", MsgBoxStyle.Critical, "Error")
                        Case Lang.Español
                            MsgBox("El color debe estar en formato Hex RGB", MsgBoxStyle.Critical, "Error")
                        Case Lang.Portugues
                            MsgBox("A cor deve estar em RGB código Hex", MsgBoxStyle.Critical, "Error")
                        Case Else
                            MsgBox("Die Farbe muss in RGB Hex-Code werden", MsgBoxStyle.Critical, "Error")
                    End Select
                    Exit Sub
                End If
                .SelectionStart = iend
...
#Region "Sprites"
    ...
    Public Sub FillSprites()
        FillSpritesList()
        Main.TreeView8.Nodes.Add("samaps")
        Main.TreeView8.Nodes.Add("models\txd").Nodes.Add("LD_BUM")
        Main.TreeView8.Nodes(1).Nodes.Add("intro1")
        Main.TreeView8.Nodes(1).Nodes.Add("intro2")
        Main.TreeView8.Nodes(1).Nodes.Add("INTRO3")
        Main.TreeView8.Nodes(1).Nodes.Add("intro4")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_BEAT")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_CARD")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_CHAT")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_DRV")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_DUAL")
        Main.TreeView8.Nodes(1).Nodes.Add("ld_grav")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_NONE")
        Main.TreeView8.Nodes(1).Nodes.Add("OTB")
        Main.TreeView8.Nodes(1).Nodes.Add("OTB2")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_PLAN")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_POKE")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_POOL")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_RACE")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_RACE1")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_RACE2")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_RACE3")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_RACE4")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_RACE5")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_ROUL")
        Main.TreeView8.Nodes(1).Nodes.Add("ld_shtr")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_SLOT")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_SPAC")
        Main.TreeView8.Nodes(1).Nodes.Add("LD_TATT")
        Main.TreeView8.Nodes(1).Nodes.Add("load0uk")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc0")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc1")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc2")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc3")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc4")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc5")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc6")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc7")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc8")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc9")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc10")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc11")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc12")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc13")
        Main.TreeView8.Nodes(1).Nodes.Add("loadsc14")
        Main.TreeView8.Nodes(1).Nodes.Add("LOADSCS")
        Main.TreeView8.Nodes(1).Nodes.Add("LOADSUK")
        Main.TreeView8.Nodes(1).Nodes.Add("outro")
        Main.TreeView8.Nodes(1).Nodes.Add("splash1")
        Main.TreeView8.Nodes(1).Nodes.Add("splash2")
        Main.TreeView8.Nodes(1).Nodes.Add("splash3")
        Main.TreeView8.Nodes.Add("All")
        For Each spr In Sprites
            If Not spr.Name Is Nothing Then
                Select Case spr.Path
                    Case "samaps"
                        Main.TreeView8.Nodes(0).Nodes.Add(spr.Name)
                    Case Else
                        Select Case spr.File
                            Case "LD_BUM"
                                Main.TreeView8.Nodes(1).Nodes(0).Nodes.Add(spr.Name)
                            Case "intro1"
                                Main.TreeView8.Nodes(1).Nodes(1).Nodes.Add(spr.Name)
                            Case "intro2"
                                Main.TreeView8.Nodes(1).Nodes(2).Nodes.Add(spr.Name)
                            Case "INTRO3"
                                Main.TreeView8.Nodes(1).Nodes(3).Nodes.Add(spr.Name)
                            Case "intro4"
                                Main.TreeView8.Nodes(1).Nodes(4).Nodes.Add(spr.Name)
                            Case "LD_BEAT"
                                Main.TreeView8.Nodes(1).Nodes(5).Nodes.Add(spr.Name)
                            Case "LD_CARD"
                                Main.TreeView8.Nodes(1).Nodes(6).Nodes.Add(spr.Name)
                            Case "LD_CHAT"
                                Main.TreeView8.Nodes(1).Nodes(7).Nodes.Add(spr.Name)
                            Case "LD_DRV"
                                Main.TreeView8.Nodes(1).Nodes(8).Nodes.Add(spr.Name)
                            Case "LD_DUAL"
                                Main.TreeView8.Nodes(1).Nodes(9).Nodes.Add(spr.Name)
                            Case "ld_grav"
                                Main.TreeView8.Nodes(1).Nodes(10).Nodes.Add(spr.Name)
                            Case "LD_NONE"
                                Main.TreeView8.Nodes(1).Nodes(11).Nodes.Add(spr.Name)
                            Case "OTB"
                                Main.TreeView8.Nodes(1).Nodes(12).Nodes.Add(spr.Name)
                            Case "OTB2"
                                Main.TreeView8.Nodes(1).Nodes(13).Nodes.Add(spr.Name)
                            Case "LD_PLAN"
                                Main.TreeView8.Nodes(1).Nodes(14).Nodes.Add(spr.Name)
                            Case "LD_POKE"
                                Main.TreeView8.Nodes(1).Nodes(15).Nodes.Add(spr.Name)
                            Case "LD_POOL"
                                Main.TreeView8.Nodes(1).Nodes(16).Nodes.Add(spr.Name)
                            Case "LD_RACE"
                                Main.TreeView8.Nodes(1).Nodes(17).Nodes.Add(spr.Name)
                            Case "LD_RACE1"
                                Main.TreeView8.Nodes(1).Nodes(18).Nodes.Add(spr.Name)
                            Case "LD_RACE2"
                                Main.TreeView8.Nodes(1).Nodes(19).Nodes.Add(spr.Name)
                            Case "LD_RACE3"
                                Main.TreeView8.Nodes(1).Nodes(20).Nodes.Add(spr.Name)
                            Case "LD_RACE4"
                                Main.TreeView8.Nodes(1).Nodes(21).Nodes.Add(spr.Name)
                            Case "LD_RACE5"
                                Main.TreeView8.Nodes(1).Nodes(22).Nodes.Add(spr.Name)
                            Case "LD_ROUL"
                                Main.TreeView8.Nodes(1).Nodes(23).Nodes.Add(spr.Name)
                            Case "ld_shtr"
                                Main.TreeView8.Nodes(1).Nodes(24).Nodes.Add(spr.Name)
                            Case "LD_SLOT"
                                Main.TreeView8.Nodes(1).Nodes(25).Nodes.Add(spr.Name)
                            Case "LD_SPAC"
                                Main.TreeView8.Nodes(1).Nodes(26).Nodes.Add(spr.Name)
                            Case "LD_TATT"
                                Main.TreeView8.Nodes(1).Nodes(27).Nodes.Add(spr.Name)
                            Case "load0uk"
                                Main.TreeView8.Nodes(1).Nodes(28).Nodes.Add(spr.Name)
                            Case "loadsc0"
                                Main.TreeView8.Nodes(1).Nodes(29).Nodes.Add(spr.Name)
                            Case "loadsc1"
                                Main.TreeView8.Nodes(1).Nodes(30).Nodes.Add(spr.Name)
                            Case "loadsc2"
                                Main.TreeView8.Nodes(1).Nodes(31).Nodes.Add(spr.Name)
                            Case "loadsc3"
                                Main.TreeView8.Nodes(1).Nodes(32).Nodes.Add(spr.Name)
                            Case "loadsc4"
                                Main.TreeView8.Nodes(1).Nodes(33).Nodes.Add(spr.Name)
                            Case "loadsc5"
                                Main.TreeView8.Nodes(1).Nodes(34).Nodes.Add(spr.Name)
                            Case "loadsc6"
                                Main.TreeView8.Nodes(1).Nodes(35).Nodes.Add(spr.Name)
                            Case "loadsc7"
                                Main.TreeView8.Nodes(1).Nodes(36).Nodes.Add(spr.Name)
                            Case "loadsc8"
                                Main.TreeView8.Nodes(1).Nodes(37).Nodes.Add(spr.Name)
                            Case "loadsc9"
                                Main.TreeView8.Nodes(1).Nodes(38).Nodes.Add(spr.Name)
                            Case "loadsc10"
                                Main.TreeView8.Nodes(1).Nodes(39).Nodes.Add(spr.Name)
                            Case "loadsc11"
                                Main.TreeView8.Nodes(1).Nodes(40).Nodes.Add(spr.Name)
                            Case "loadsc12"
                                Main.TreeView8.Nodes(1).Nodes(41).Nodes.Add(spr.Name)
                            Case "loadsc13"
                                Main.TreeView8.Nodes(1).Nodes(42).Nodes.Add(spr.Name)
                            Case "loadsc14"
                                Main.TreeView8.Nodes(1).Nodes(43).Nodes.Add(spr.Name)
                            Case "LOADSCS"
                                Main.TreeView8.Nodes(1).Nodes(44).Nodes.Add(spr.Name)
                            Case "LOADSUK"
                                Main.TreeView8.Nodes(1).Nodes(45).Nodes.Add(spr.Name)
                            Case "outro"
                                Main.TreeView8.Nodes(1).Nodes(46).Nodes.Add(spr.Name)
                            Case "splash1"
                                Main.TreeView8.Nodes(1).Nodes(47).Nodes.Add(spr.Name)
                            Case "splash2"
                                Main.TreeView8.Nodes(1).Nodes(48).Nodes.Add(spr.Name)
                            Case "splash3"
                                Main.TreeView8.Nodes(1).Nodes(49).Nodes.Add(spr.Name)
                        End Select
                End Select
                Main.TreeView8.Nodes(2).Nodes.Add(spr.Name)
                Splash.ProgressBar1.Value += 1
            End If
        Next
    End Sub

    Private Sub FillSpritesList()
        On Error Resume Next
        Splash.Label1.Text = "Loading map sprites..."
        Sprites(0).Name = "intro1"
        Sprites(0).Path = "models\txd"
        Sprites(0).File = "Intro1"
        Sprites(0).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_0.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_0.bmp").Size.Height
        Sprites(1).Name = "intro2"
        Sprites(1).Path = "models\txd"
        Sprites(1).File = "intro2"
        Sprites(1).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_1.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_1.bmp").Size.Height
        Sprites(2).Name = "intro3"
        Sprites(2).Path = "models\txd"
        Sprites(2).File = "INTRO3"
        Sprites(2).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_2.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_2.bmp").Size.Height
        Sprites(3).Name = "intro4"
        Sprites(3).Path = "models\txd"
        Sprites(3).File = "intro4"
        Sprites(3).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_3.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_3.bmp").Size.Height
        Sprites(4).Name = "chit"
        Sprites(4).Path = "models\txd"
        Sprites(4).File = "LD_BEAT"
        Sprites(4).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_4.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_4.bmp").Size.Height
        Sprites(5).Name = "circle"
        Sprites(5).Path = "models\txd"
        Sprites(5).File = "LD_BEAT"
        Sprites(5).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_5.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_5.bmp").Size.Height
        Sprites(6).Name = "cring"
        Sprites(6).Path = "models\txd"
        Sprites(6).File = "LD_BEAT"
        Sprites(6).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_6.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_6.bmp").Size.Height
        Sprites(7).Name = "cross"
        Sprites(7).Path = "models\txd"
        Sprites(7).File = "LD_BEAT"
        Sprites(7).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_7.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_7.bmp").Size.Height
        Sprites(8).Name = "down"
        Sprites(8).Path = "models\txd"
        Sprites(8).File = "LD_BEAT"
        Sprites(8).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_8.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_8.bmp").Size.Height
        Sprites(9).Name = "downl"
        Sprites(9).Path = "models\txd"
        Sprites(9).File = "LD_BEAT"
        Sprites(9).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_9.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_9.bmp").Size.Height
        Sprites(10).Name = "downr"
        Sprites(10).Path = "models\txd"
        Sprites(10).File = "LD_BEAT"
        Sprites(10).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_10.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_10.bmp").Size.Height
        Sprites(11).Name = "left"
        Sprites(11).Path = "models\txd"
        Sprites(11).File = "LD_BEAT"
        Sprites(11).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_11.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_11.bmp").Size.Height
        Sprites(12).Name = "right"
        Sprites(12).Path = "models\txd"
        Sprites(12).File = "LD_BEAT"
        Sprites(12).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_12.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_12.bmp").Size.Height
        Sprites(13).Name = "square"
        Sprites(13).Path = "models\txd"
        Sprites(13).File = "LD_BEAT"
        Sprites(13).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_13.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_13.bmp").Size.Height
        Sprites(14).Name = "triang"
        Sprites(14).Path = "models\txd"
        Sprites(14).File = "LD_BEAT"
        Sprites(14).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_14.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_14.bmp").Size.Height
        Sprites(15).Name = "up"
        Sprites(15).Path = "models\txd"
        Sprites(15).File = "LD_BEAT"
        Sprites(15).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_15.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_15.bmp").Size.Height
        Sprites(16).Name = "upl"
        Sprites(16).Path = "models\txd"
        Sprites(16).File = "LD_BEAT"
        Sprites(16).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_16.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_16.bmp").Size.Height
        Sprites(17).Name = "upr"
        Sprites(17).Path = "models\txd"
        Sprites(17).File = "LD_BEAT"
        Sprites(17).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_17.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_17.bmp").Size.Height
        Sprites(18).Name = "blkdot"
        Sprites(18).Path = "models\txd"
        Sprites(18).File = "LD_BUM"
        Sprites(18).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_18.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_18.bmp").Size.Height
        Sprites(19).Name = "bum1"
        Sprites(19).Path = "models\txd"
        Sprites(19).File = "LD_BUM"
        Sprites(19).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_19.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_19.bmp").Size.Height
        Sprites(20).Name = "bum2"
        Sprites(20).Path = "models\txd"
        Sprites(20).File = "LD_BUM"
        Sprites(20).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_20.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_20.bmp").Size.Height
        Sprites(21).Name = "cd10c"
        Sprites(21).Path = "models\txd"
        Sprites(21).File = "LD_CARD"
        Sprites(21).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_21.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_21.bmp").Size.Height
        Sprites(22).Name = "cd10d"
        Sprites(22).Path = "models\txd"
        Sprites(22).File = "LD_CARD"
        Sprites(22).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_22.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_22.bmp").Size.Height
        Sprites(23).Name = "cd10h"
        Sprites(23).Path = "models\txd"
        Sprites(23).File = "LD_CARD"
        Sprites(23).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_23.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_23.bmp").Size.Height
        Sprites(24).Name = "cd10s"
        Sprites(24).Path = "models\txd"
        Sprites(24).File = "LD_CARD"
        Sprites(24).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_24.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_24.bmp").Size.Height
        Sprites(25).Name = "cd11c"
        Sprites(25).Path = "models\txd"
        Sprites(25).File = "LD_CARD"
        Sprites(25).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_25.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_25.bmp").Size.Height
        Sprites(26).Name = "cd11d"
        Sprites(26).Path = "models\txd"
        Sprites(26).File = "LD_CARD"
        Sprites(26).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_26.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_26.bmp").Size.Height
        Sprites(27).Name = "cd11h"
        Sprites(27).Path = "models\txd"
        Sprites(27).File = "LD_CARD"
        Sprites(27).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_27.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_27.bmp").Size.Height
        Sprites(28).Name = "cd11s"
        Sprites(28).Path = "models\txd"
        Sprites(28).File = "LD_CARD"
        Sprites(28).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_28.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_28.bmp").Size.Height
        Sprites(29).Name = "cd12c"
        Sprites(29).Path = "models\txd"
        Sprites(29).File = "LD_CARD"
        Sprites(29).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_29.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_29.bmp").Size.Height
        Sprites(30).Name = "cd12d"
        Sprites(30).Path = "models\txd"
        Sprites(30).File = "LD_CARD"
        Sprites(30).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_30.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_30.bmp").Size.Height
        Sprites(31).Name = "cd12h"
        Sprites(31).Path = "models\txd"
        Sprites(31).File = "LD_CARD"
        Sprites(31).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_31.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_31.bmp").Size.Height
        Sprites(32).Name = "cd12s"
        Sprites(32).Path = "models\txd"
        Sprites(32).File = "LD_CARD"
        Sprites(32).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_32.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_32.bmp").Size.Height
        Sprites(33).Name = "cd13c"
        Sprites(33).Path = "models\txd"
        Sprites(33).File = "LD_CARD"
        Sprites(33).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_33.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_33.bmp").Size.Height
        Sprites(34).Name = "cd13d"
        Sprites(34).Path = "models\txd"
        Sprites(34).File = "LD_CARD"
        Sprites(34).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_34.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_34.bmp").Size.Height
        Sprites(35).Name = "cd13h"
        Sprites(35).Path = "models\txd"
        Sprites(35).File = "LD_CARD"
        Sprites(35).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_35.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_35.bmp").Size.Height
        Sprites(36).Name = "cd13s"
        Sprites(36).Path = "models\txd"
        Sprites(36).File = "LD_CARD"
        Sprites(36).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_36.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_36.bmp").Size.Height
        Sprites(37).Name = "cd1c"
        Sprites(37).Path = "models\txd"
        Sprites(37).File = "LD_CARD"
        Sprites(37).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_37.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_37.bmp").Size.Height
        Sprites(38).Name = "cd1d"
        Sprites(38).Path = "models\txd"
        Sprites(38).File = "LD_CARD"
        Sprites(38).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_38.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_38.bmp").Size.Height
        Sprites(39).Name = "cd1h"
        Sprites(39).Path = "models\txd"
        Sprites(39).File = "LD_CARD"
        Sprites(39).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_39.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_39.bmp").Size.Height
        Sprites(40).Name = "cd1s"
        Sprites(40).Path = "models\txd"
        Sprites(40).File = "LD_CARD"
        Sprites(40).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_40.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_40.bmp").Size.Height
        Sprites(41).Name = "cd2c"
        Sprites(41).Path = "models\txd"
        Sprites(41).File = "LD_CARD"
        Sprites(41).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_41.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_41.bmp").Size.Height
        Sprites(42).Name = "cd2d"
        Sprites(42).Path = "models\txd"
        Sprites(42).File = "LD_CARD"
        Sprites(42).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_42.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_42.bmp").Size.Height
        Sprites(43).Name = "cd2h"
        Sprites(43).Path = "models\txd"
        Sprites(43).File = "LD_CARD"
        Sprites(43).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_43.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_43.bmp").Size.Height
        Sprites(44).Name = "cd2s"
        Sprites(44).Path = "models\txd"
        Sprites(44).File = "LD_CARD"
        Sprites(44).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_44.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_44.bmp").Size.Height
        Sprites(45).Name = "cd3c"
        Sprites(45).Path = "models\txd"
        Sprites(45).File = "LD_CARD"
        Sprites(45).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_45.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_45.bmp").Size.Height
        Sprites(46).Name = "cd3d"
        Sprites(46).Path = "models\txd"
        Sprites(46).File = "LD_CARD"
        Sprites(46).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_46.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_46.bmp").Size.Height
        Sprites(47).Name = "cd3h"
        Sprites(47).Path = "models\txd"
        Sprites(47).File = "LD_CARD"
        Sprites(47).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_47.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_47.bmp").Size.Height
        Sprites(48).Name = "cd3s"
        Sprites(48).Path = "models\txd"
        Sprites(48).File = "LD_CARD"
        Sprites(48).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_48.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_48.bmp").Size.Height
        Sprites(49).Name = "cd4c"
        Sprites(49).Path = "models\txd"
        Sprites(49).File = "LD_CARD"
        Sprites(49).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_49.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_49.bmp").Size.Height
        Sprites(50).Name = "cd4d"
        Sprites(50).Path = "models\txd"
        Sprites(50).File = "LD_CARD"
        Sprites(50).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_50.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_50.bmp").Size.Height
        Sprites(51).Name = "cd4h"
        Sprites(51).Path = "models\txd"
        Sprites(51).File = "LD_CARD"
        Sprites(51).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_51.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_51.bmp").Size.Height
        Sprites(52).Name = "cd4s"
        Sprites(52).Path = "models\txd"
        Sprites(52).File = "LD_CARD"
        Sprites(52).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_52.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_52.bmp").Size.Height
        Sprites(53).Name = "cd5c"
        Sprites(53).Path = "models\txd"
        Sprites(53).File = "LD_CARD"
        Sprites(53).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_53.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_53.bmp").Size.Height
        Sprites(54).Name = "cd5d"
        Sprites(54).Path = "models\txd"
        Sprites(54).File = "LD_CARD"
        Sprites(54).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_54.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_54.bmp").Size.Height
        Sprites(55).Name = "cd5h"
        Sprites(55).Path = "models\txd"
        Sprites(55).File = "LD_CARD"
        Sprites(55).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_55.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_55.bmp").Size.Height
        Sprites(56).Name = "cd5s"
        Sprites(56).Path = "models\txd"
        Sprites(56).File = "LD_CARD"
        Sprites(56).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_56.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_56.bmp").Size.Height
        Sprites(57).Name = "cd6c"
        Sprites(57).Path = "models\txd"
        Sprites(57).File = "LD_CARD"
        Sprites(57).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_57.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_57.bmp").Size.Height
        Sprites(58).Name = "cd6d"
        Sprites(58).Path = "models\txd"
        Sprites(58).File = "LD_CARD"
        Sprites(58).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_58.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_58.bmp").Size.Height
        Sprites(59).Name = "cd6h"
        Sprites(59).Path = "models\txd"
        Sprites(59).File = "LD_CARD"
        Sprites(59).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_59.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_59.bmp").Size.Height
        Sprites(60).Name = "cd6s"
        Sprites(60).Path = "models\txd"
        Sprites(60).File = "LD_CARD"
        Sprites(60).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_60.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_60.bmp").Size.Height
        Sprites(61).Name = "cd7c"
        Sprites(61).Path = "models\txd"
        Sprites(61).File = "LD_CARD"
        Sprites(61).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_61.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_61.bmp").Size.Height
        Sprites(62).Name = "cd7d"
        Sprites(62).Path = "models\txd"
        Sprites(62).File = "LD_CARD"
        Sprites(62).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_62.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_62.bmp").Size.Height
        Sprites(63).Name = "cd7h"
        Sprites(63).Path = "models\txd"
        Sprites(63).File = "LD_CARD"
        Sprites(63).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_63.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_63.bmp").Size.Height
        Sprites(64).Name = "cd7s"
        Sprites(64).Path = "models\txd"
        Sprites(64).File = "LD_CARD"
        Sprites(64).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_64.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_64.bmp").Size.Height
        Sprites(65).Name = "cd8c"
        Sprites(65).Path = "models\txd"
        Sprites(65).File = "LD_CARD"
        Sprites(65).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_65.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_65.bmp").Size.Height
        Sprites(66).Name = "cd8d"
        Sprites(66).Path = "models\txd"
        Sprites(66).File = "LD_CARD"
        Sprites(66).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_66.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_66.bmp").Size.Height
        Sprites(67).Name = "cd8h"
        Sprites(67).Path = "models\txd"
        Sprites(67).File = "LD_CARD"
        Sprites(67).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_67.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_67.bmp").Size.Height
        Sprites(68).Name = "cd8s"
        Sprites(68).Path = "models\txd"
        Sprites(68).File = "LD_CARD"
        Sprites(68).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_68.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_68.bmp").Size.Height
        Sprites(69).Name = "cd9c"
        Sprites(69).Path = "models\txd"
        Sprites(69).File = "LD_CARD"
        Sprites(69).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_69.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_69.bmp").Size.Height
        Sprites(70).Name = "cd9d"
        Sprites(70).Path = "models\txd"
        Sprites(70).File = "LD_CARD"
        Sprites(70).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_70.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_70.bmp").Size.Height
        Sprites(71).Name = "cd9h"
        Sprites(71).Path = "models\txd"
        Sprites(71).File = "LD_CARD"
        Sprites(71).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_71.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_71.bmp").Size.Height
        Sprites(72).Name = "cd9s"
        Sprites(72).Path = "models\txd"
        Sprites(72).File = "LD_CARD"
        Sprites(72).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_72.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_72.bmp").Size.Height
        Sprites(73).Name = "cdback"
        Sprites(73).Path = "models\txd"
        Sprites(73).File = "LD_CARD"
        Sprites(73).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_73.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_73.bmp").Size.Height
        Sprites(74).Name = "badchat"
        Sprites(74).Path = "models\txd"
        Sprites(74).File = "LD_CHAT"
        Sprites(74).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_74.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_74.bmp").Size.Height
        Sprites(75).Name = "dpad_64"
        Sprites(75).Path = "models\txd"
        Sprites(75).File = "LD_CHAT"
        Sprites(75).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_75.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_75.bmp").Size.Height
        Sprites(76).Name = "dpad_lr"
        Sprites(76).Path = "models\txd"
        Sprites(76).File = "LD_CHAT"
        Sprites(76).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_76.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_76.bmp").Size.Height
        Sprites(77).Name = "goodcha"
        Sprites(77).Path = "models\txd"
        Sprites(77).File = "LD_CHAT"
        Sprites(77).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_77.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_77.bmp").Size.Height
        Sprites(78).Name = "thumbdn"
        Sprites(78).Path = "models\txd"
        Sprites(78).File = "LD_CHAT"
        Sprites(78).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_78.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_78.bmp").Size.Height
        Sprites(79).Name = "thumbup"
        Sprites(79).Path = "models\txd"
        Sprites(79).File = "LD_CHAT"
        Sprites(79).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_79.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_79.bmp").Size.Height
        Sprites(80).Name = "blkdot"
        Sprites(80).Path = "models\txd"
        Sprites(80).File = "LD_DRV"
        Sprites(80).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_80.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_80.bmp").Size.Height
        Sprites(81).Name = "brboat"
        Sprites(81).Path = "models\txd"
        Sprites(81).File = "LD_DRV"
        Sprites(81).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_81.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_81.bmp").Size.Height
        Sprites(82).Name = "brfly"
        Sprites(82).Path = "models\txd"
        Sprites(82).File = "LD_DRV"
        Sprites(82).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_82.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_82.bmp").Size.Height
        Sprites(83).Name = "bronze"
        Sprites(83).Path = "models\txd"
        Sprites(83).File = "LD_DRV"
        Sprites(83).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_83.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_83.bmp").Size.Height
        Sprites(84).Name = "goboat"
        Sprites(84).Path = "models\txd"
        Sprites(84).File = "LD_DRV"
        Sprites(84).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_84.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_84.bmp").Size.Height
        Sprites(85).Name = "gold"
        Sprites(85).Path = "models\txd"
        Sprites(85).File = "LD_DRV"
        Sprites(85).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_85.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_85.bmp").Size.Height
        Sprites(86).Name = "golfly"
        Sprites(86).Path = "models\txd"
        Sprites(86).File = "LD_DRV"
        Sprites(86).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_86.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_86.bmp").Size.Height
        Sprites(87).Name = "naward"
        Sprites(87).Path = "models\txd"
        Sprites(87).File = "LD_DRV"
        Sprites(87).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_87.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_87.bmp").Size.Height
        Sprites(88).Name = "nawtxt"
        Sprites(88).Path = "models\txd"
        Sprites(88).File = "LD_DRV"
        Sprites(88).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_88.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_88.bmp").Size.Height
        Sprites(89).Name = "ribb"
        Sprites(89).Path = "models\txd"
        Sprites(89).File = "LD_DRV"
        Sprites(89).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_89.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_89.bmp").Size.Height
        Sprites(90).Name = "ribbw"
        Sprites(90).Path = "models\txd"
        Sprites(90).File = "LD_DRV"
        Sprites(90).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_90.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_90.bmp").Size.Height
        Sprites(91).Name = "silboat"
        Sprites(91).Path = "models\txd"
        Sprites(91).File = "LD_DRV"
        Sprites(91).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_91.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_91.bmp").Size.Height
        Sprites(92).Name = "silfly"
        Sprites(92).Path = "models\txd"
        Sprites(92).File = "LD_DRV"
        Sprites(92).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_92.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_92.bmp").Size.Height
        Sprites(93).Name = "silver"
        Sprites(93).Path = "models\txd"
        Sprites(93).File = "LD_DRV"
        Sprites(93).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_93.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_93.bmp").Size.Height
        Sprites(94).Name = "tvbase"
        Sprites(94).Path = "models\txd"
        Sprites(94).File = "LD_DRV"
        Sprites(94).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_94.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_94.bmp").Size.Height
        Sprites(95).Name = "tvcorn"
        Sprites(95).Path = "models\txd"
        Sprites(95).File = "LD_DRV"
        Sprites(95).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_95.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_95.bmp").Size.Height
        Sprites(96).Name = "backgnd"
        Sprites(96).Path = "models\txd"
        Sprites(96).File = "LD_DUAL"
        Sprites(96).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_96.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_96.bmp").Size.Height
        Sprites(97).Name = "black"
        Sprites(97).Path = "models\txd"
        Sprites(97).File = "LD_DUAL"
        Sprites(97).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_97.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_97.bmp").Size.Height
        Sprites(98).Name = "dark"
        Sprites(98).Path = "models\txd"
        Sprites(98).File = "LD_DUAL"
        Sprites(98).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_98.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_98.bmp").Size.Height
        Sprites(99).Name = "DUALITY"
        Sprites(99).Path = "models\txd"
        Sprites(99).File = "LD_DUAL"
        Sprites(99).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_99.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_99.bmp").Size.Height
        Sprites(100).Name = "ex1"
        Sprites(100).Path = "models\txd"
        Sprites(100).File = "LD_DUAL"
        Sprites(100).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_100.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_100.bmp").Size.Height
        Sprites(101).Name = "ex2"
        Sprites(101).Path = "models\txd"
        Sprites(101).File = "LD_DUAL"
        Sprites(101).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_101.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_101.bmp").Size.Height
        Sprites(102).Name = "ex3"
        Sprites(102).Path = "models\txd"
        Sprites(102).File = "LD_DUAL"
        Sprites(102).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_102.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_102.bmp").Size.Height
        Sprites(103).Name = "ex4"
        Sprites(103).Path = "models\txd"
        Sprites(103).File = "LD_DUAL"
        Sprites(103).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_103.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_103.bmp").Size.Height
        Sprites(104).Name = "Health"
        Sprites(104).Path = "models\txd"
        Sprites(104).File = "LD_DUAL"
        Sprites(104).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_104.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_104.bmp").Size.Height
        Sprites(105).Name = "layer"
        Sprites(105).Path = "models\txd"
        Sprites(105).File = "LD_DUAL"
        Sprites(105).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_105.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_105.bmp").Size.Height
        Sprites(106).Name = "light"
        Sprites(106).Path = "models\txd"
        Sprites(106).File = "LD_DUAL"
        Sprites(106).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_106.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_106.bmp").Size.Height
        Sprites(107).Name = "power"
        Sprites(107).Path = "models\txd"
        Sprites(107).File = "LD_DUAL"
        Sprites(107).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_107.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_107.bmp").Size.Height
        Sprites(108).Name = "rockshp"
        Sprites(108).Path = "models\txd"
        Sprites(108).File = "LD_DUAL"
        Sprites(108).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_108.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_108.bmp").Size.Height
        Sprites(109).Name = "shoot"
        Sprites(109).Path = "models\txd"
        Sprites(109).File = "LD_DUAL"
        Sprites(109).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_109.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_109.bmp").Size.Height
        Sprites(110).Name = "shoota"
        Sprites(110).Path = "models\txd"
        Sprites(110).File = "LD_DUAL"
        Sprites(110).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_110.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_110.bmp").Size.Height
        Sprites(111).Name = "thrustG"
        Sprites(111).Path = "models\txd"
        Sprites(111).File = "LD_DUAL"
        Sprites(111).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_111.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_111.bmp").Size.Height
        Sprites(112).Name = "tvcorn"
        Sprites(112).Path = "models\txd"
        Sprites(112).File = "LD_DUAL"
        Sprites(112).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_112.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_112.bmp").Size.Height
        Sprites(113).Name = "white"
        Sprites(113).Path = "models\txd"
        Sprites(113).File = "LD_DUAL"
        Sprites(113).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_113.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_113.bmp").Size.Height
        Sprites(114).Name = "bee1"
        Sprites(114).Path = "models\txd"
        Sprites(114).File = "ld_grav"
        Sprites(114).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_114.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_114.bmp").Size.Height
        Sprites(115).Name = "bee2"
        Sprites(115).Path = "models\txd"
        Sprites(115).File = "ld_grav"
        Sprites(115).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_115.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_115.bmp").Size.Height
        Sprites(116).Name = "bumble"
        Sprites(116).Path = "models\txd"
        Sprites(116).File = "ld_grav"
        Sprites(116).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_116.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_116.bmp").Size.Height
        Sprites(117).Name = "exitw"
        Sprites(117).Path = "models\txd"
        Sprites(117).File = "ld_grav"
        Sprites(117).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_117.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_117.bmp").Size.Height
        Sprites(118).Name = "exity"
        Sprites(118).Path = "models\txd"
        Sprites(118).File = "ld_grav"
        Sprites(118).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_118.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_118.bmp").Size.Height
        Sprites(119).Name = "flwr"
        Sprites(119).Path = "models\txd"
        Sprites(119).File = "ld_grav"
        Sprites(119).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_119.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_119.bmp").Size.Height
        Sprites(120).Name = "ghost"
        Sprites(120).Path = "models\txd"
        Sprites(120).File = "ld_grav"
        Sprites(120).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_120.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_120.bmp").Size.Height
        Sprites(121).Name = "hiscorew"
        Sprites(121).Path = "models\txd"
        Sprites(121).File = "ld_grav"
        Sprites(121).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_121.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_121.bmp").Size.Height
        Sprites(122).Name = "hiscorey"
        Sprites(122).Path = "models\txd"
        Sprites(122).File = "ld_grav"
        Sprites(122).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_122.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_122.bmp").Size.Height
        Sprites(123).Name = "hive"
        Sprites(123).Path = "models\txd"
        Sprites(123).File = "ld_grav"
        Sprites(123).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_123.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_123.bmp").Size.Height
        Sprites(124).Name = "hon"
        Sprites(124).Path = "models\txd"
        Sprites(124).File = "ld_grav"
        Sprites(124).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_124.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_124.bmp").Size.Height
        Sprites(125).Name = "leaf"
        Sprites(125).Path = "models\txd"
        Sprites(125).File = "ld_grav"
        Sprites(125).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_125.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_125.bmp").Size.Height
        Sprites(126).Name = "playw"
        Sprites(126).Path = "models\txd"
        Sprites(126).File = "ld_grav"
        Sprites(126).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_126.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_126.bmp").Size.Height
        Sprites(127).Name = "playy"
        Sprites(127).Path = "models\txd"
        Sprites(127).File = "ld_grav"
        Sprites(127).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_127.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_127.bmp").Size.Height
        Sprites(128).Name = "sky"
        Sprites(128).Path = "models\txd"
        Sprites(128).File = "ld_grav"
        Sprites(128).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_128.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_128.bmp").Size.Height
        Sprites(129).Name = "thorn"
        Sprites(129).Path = "models\txd"
        Sprites(129).File = "ld_grav"
        Sprites(129).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_129.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_129.bmp").Size.Height
        Sprites(130).Name = "timer"
        Sprites(130).Path = "models\txd"
        Sprites(130).File = "ld_grav"
        Sprites(130).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_130.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_130.bmp").Size.Height
        Sprites(131).Name = "tvcorn"
        Sprites(131).Path = "models\txd"
        Sprites(131).File = "ld_grav"
        Sprites(131).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_131.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_131.bmp").Size.Height
        Sprites(132).Name = "tvl"
        Sprites(132).Path = "models\txd"
        Sprites(132).File = "ld_grav"
        Sprites(132).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_132.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_132.bmp").Size.Height
        Sprites(133).Name = "tvr"
        Sprites(133).Path = "models\txd"
        Sprites(133).File = "ld_grav"
        Sprites(133).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_133.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_133.bmp").Size.Height
        Sprites(134).Name = "explm01"
        Sprites(134).Path = "models\txd"
        Sprites(134).File = "LD_NONE"
        Sprites(134).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_134.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_134.bmp").Size.Height
        Sprites(135).Name = "explm02"
        Sprites(135).Path = "models\txd"
        Sprites(135).File = "LD_NONE"
        Sprites(135).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_135.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_135.bmp").Size.Height
        Sprites(136).Name = "explm03"
        Sprites(136).Path = "models\txd"
        Sprites(136).File = "LD_NONE"
        Sprites(136).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_136.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_136.bmp").Size.Height
        Sprites(137).Name = "explm04"
        Sprites(137).Path = "models\txd"
        Sprites(137).File = "LD_NONE"
        Sprites(137).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_137.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_137.bmp").Size.Height
        Sprites(138).Name = "explm05"
        Sprites(138).Path = "models\txd"
        Sprites(138).File = "LD_NONE"
        Sprites(138).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_138.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_138.bmp").Size.Height
        Sprites(139).Name = "explm06"
        Sprites(139).Path = "models\txd"
        Sprites(139).File = "LD_NONE"
        Sprites(139).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_139.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_139.bmp").Size.Height
        Sprites(140).Name = "explm07"
        Sprites(140).Path = "models\txd"
        Sprites(140).File = "LD_NONE"
        Sprites(140).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_140.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_140.bmp").Size.Height
        Sprites(141).Name = "explm08"
        Sprites(141).Path = "models\txd"
        Sprites(141).File = "LD_NONE"
        Sprites(141).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_141.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_141.bmp").Size.Height
        Sprites(142).Name = "explm09"
        Sprites(142).Path = "models\txd"
        Sprites(142).File = "LD_NONE"
        Sprites(142).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_142.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_142.bmp").Size.Height
        Sprites(143).Name = "explm10"
        Sprites(143).Path = "models\txd"
        Sprites(143).File = "LD_NONE"
        Sprites(143).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_143.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_143.bmp").Size.Height
        Sprites(144).Name = "explm11"
        Sprites(144).Path = "models\txd"
        Sprites(144).File = "LD_NONE"
        Sprites(144).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_144.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_144.bmp").Size.Height
        Sprites(145).Name = "explm12"
        Sprites(145).Path = "models\txd"
        Sprites(145).File = "LD_NONE"
        Sprites(145).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_145.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_145.bmp").Size.Height
        Sprites(146).Name = "force"
        Sprites(146).Path = "models\txd"
        Sprites(146).File = "LD_NONE"
        Sprites(146).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_146.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_146.bmp").Size.Height
        Sprites(147).Name = "light"
        Sprites(147).Path = "models\txd"
        Sprites(147).File = "LD_NONE"
        Sprites(147).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_147.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_147.bmp").Size.Height
        Sprites(148).Name = "ship"
        Sprites(148).Path = "models\txd"
        Sprites(148).File = "LD_NONE"
        Sprites(148).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_148.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_148.bmp").Size.Height
        Sprites(149).Name = "ship2"
        Sprites(149).Path = "models\txd"
        Sprites(149).File = "LD_NONE"
        Sprites(149).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_149.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_149.bmp").Size.Height
        Sprites(150).Name = "ship3"
        Sprites(150).Path = "models\txd"
        Sprites(150).File = "LD_NONE"
        Sprites(150).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_150.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_150.bmp").Size.Height
        Sprites(151).Name = "shoot"
        Sprites(151).Path = "models\txd"
        Sprites(151).File = "LD_NONE"
        Sprites(151).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_151.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_151.bmp").Size.Height
        Sprites(152).Name = "shpnorm"
        Sprites(152).Path = "models\txd"
        Sprites(152).File = "LD_NONE"
        Sprites(152).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_152.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_152.bmp").Size.Height
        Sprites(153).Name = "shpwarp"
        Sprites(153).Path = "models\txd"
        Sprites(153).File = "LD_NONE"
        Sprites(153).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_153.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_153.bmp").Size.Height
        Sprites(154).Name = "thrust"
        Sprites(154).Path = "models\txd"
        Sprites(154).File = "LD_NONE"
        Sprites(154).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_154.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_154.bmp").Size.Height
        Sprites(155).Name = "title"
        Sprites(155).Path = "models\txd"
        Sprites(155).File = "LD_NONE"
        Sprites(155).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_155.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_155.bmp").Size.Height
        Sprites(156).Name = "tvcorn"
        Sprites(156).Path = "models\txd"
        Sprites(156).File = "LD_NONE"
        Sprites(156).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_156.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_156.bmp").Size.Height
        Sprites(157).Name = "warp"
        Sprites(157).Path = "models\txd"
        Sprites(157).File = "LD_NONE"
        Sprites(157).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_157.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_157.bmp").Size.Height
        Sprites(158).Name = "AirLogo"
        Sprites(158).Path = "models\txd"
        Sprites(158).File = "LD_PLAN"
        Sprites(158).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_158.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_158.bmp").Size.Height
        Sprites(159).Name = "blkdot"
        Sprites(159).Path = "models\txd"
        Sprites(159).File = "LD_PLAN"
        Sprites(159).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_159.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_159.bmp").Size.Height
        Sprites(160).Name = "tvbase"
        Sprites(160).Path = "models\txd"
        Sprites(160).File = "LD_PLAN"
        Sprites(160).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_160.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_160.bmp").Size.Height
        Sprites(161).Name = "tvcorn"
        Sprites(161).Path = "models\txd"
        Sprites(161).File = "LD_PLAN"
        Sprites(161).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_161.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_161.bmp").Size.Height
        Sprites(162).Name = "addcoin"
        Sprites(162).Path = "models\txd"
        Sprites(162).File = "LD_POKE"
        Sprites(162).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_162.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_162.bmp").Size.Height
        Sprites(163).Name = "backcyan"
        Sprites(163).Path = "models\txd"
        Sprites(163).File = "LD_POKE"
        Sprites(163).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_163.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_163.bmp").Size.Height
        Sprites(164).Name = "backred"
        Sprites(164).Path = "models\txd"
        Sprites(164).File = "LD_POKE"
        Sprites(164).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_164.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_164.bmp").Size.Height
        Sprites(165).Name = "cd10c"
        Sprites(165).Path = "models\txd"
        Sprites(165).File = "LD_POKE"
        Sprites(165).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_165.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_165.bmp").Size.Height
        Sprites(166).Name = "cd10d"
        Sprites(166).Path = "models\txd"
        Sprites(166).File = "LD_POKE"
        Sprites(166).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_166.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_166.bmp").Size.Height
        Sprites(167).Name = "cd10h"
        Sprites(167).Path = "models\txd"
        Sprites(167).File = "LD_POKE"
        Sprites(167).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_167.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_167.bmp").Size.Height
        Sprites(168).Name = "cd10s"
        Sprites(168).Path = "models\txd"
        Sprites(168).File = "LD_POKE"
        Sprites(168).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_168.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_168.bmp").Size.Height
        Sprites(169).Name = "cd11c"
        Sprites(169).Path = "models\txd"
        Sprites(169).File = "LD_POKE"
        Sprites(169).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_169.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_169.bmp").Size.Height
        Sprites(170).Name = "cd11d"
        Sprites(170).Path = "models\txd"
        Sprites(170).File = "LD_POKE"
        Sprites(170).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_170.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_170.bmp").Size.Height
        Sprites(171).Name = "cd11h"
        Sprites(171).Path = "models\txd"
        Sprites(171).File = "LD_POKE"
        Sprites(171).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_171.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_171.bmp").Size.Height
        Sprites(172).Name = "cd11s"
        Sprites(172).Path = "models\txd"
        Sprites(172).File = "LD_POKE"
        Sprites(172).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_172.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_172.bmp").Size.Height
        Sprites(173).Name = "cd12c"
        Sprites(173).Path = "models\txd"
        Sprites(173).File = "LD_POKE"
        Sprites(173).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_173.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_173.bmp").Size.Height
        Sprites(174).Name = "cd12d"
        Sprites(174).Path = "models\txd"
        Sprites(174).File = "LD_POKE"
        Sprites(174).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_174.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_174.bmp").Size.Height
        Sprites(175).Name = "cd12h"
        Sprites(175).Path = "models\txd"
        Sprites(175).File = "LD_POKE"
        Sprites(175).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_175.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_175.bmp").Size.Height
        Sprites(176).Name = "cd12s"
        Sprites(176).Path = "models\txd"
        Sprites(176).File = "LD_POKE"
        Sprites(176).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_176.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_176.bmp").Size.Height
        Sprites(177).Name = "cd13c"
        Sprites(177).Path = "models\txd"
        Sprites(177).File = "LD_POKE"
        Sprites(177).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_177.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_177.bmp").Size.Height
        Sprites(178).Name = "cd13d"
        Sprites(178).Path = "models\txd"
        Sprites(178).File = "LD_POKE"
        Sprites(178).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_178.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_178.bmp").Size.Height
        Sprites(179).Name = "cd13h"
        Sprites(179).Path = "models\txd"
        Sprites(179).File = "LD_POKE"
        Sprites(179).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_179.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_179.bmp").Size.Height
        Sprites(180).Name = "cd13s"
        Sprites(180).Path = "models\txd"
        Sprites(180).File = "LD_POKE"
        Sprites(180).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_180.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_180.bmp").Size.Height
        Sprites(181).Name = "cd1c"
        Sprites(181).Path = "models\txd"
        Sprites(181).File = "LD_POKE"
        Sprites(181).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_181.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_181.bmp").Size.Height
        Sprites(182).Name = "cd1d"
        Sprites(182).Path = "models\txd"
        Sprites(182).File = "LD_POKE"
        Sprites(182).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_182.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_182.bmp").Size.Height
        Sprites(183).Name = "cd1h"
        Sprites(183).Path = "models\txd"
        Sprites(183).File = "LD_POKE"
        Sprites(183).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_183.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_183.bmp").Size.Height
        Sprites(184).Name = "cd1s"
        Sprites(184).Path = "models\txd"
        Sprites(184).File = "LD_POKE"
        Sprites(184).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_184.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_184.bmp").Size.Height
        Sprites(185).Name = "cd2c"
        Sprites(185).Path = "models\txd"
        Sprites(185).File = "LD_POKE"
        Sprites(185).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_185.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_185.bmp").Size.Height
        Sprites(186).Name = "cd2d"
        Sprites(186).Path = "models\txd"
        Sprites(186).File = "LD_POKE"
        Sprites(186).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_186.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_186.bmp").Size.Height
        Sprites(187).Name = "cd2h"
        Sprites(187).Path = "models\txd"
        Sprites(187).File = "LD_POKE"
        Sprites(187).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_187.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_187.bmp").Size.Height
        Sprites(188).Name = "cd2s"
        Sprites(188).Path = "models\txd"
        Sprites(188).File = "LD_POKE"
        Sprites(188).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_188.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_188.bmp").Size.Height
        Sprites(189).Name = "cd3c"
        Sprites(189).Path = "models\txd"
        Sprites(189).File = "LD_POKE"
        Sprites(189).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_189.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_189.bmp").Size.Height
        Sprites(190).Name = "cd3d"
        Sprites(190).Path = "models\txd"
        Sprites(190).File = "LD_POKE"
        Sprites(190).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_190.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_190.bmp").Size.Height
        Sprites(191).Name = "cd3h"
        Sprites(191).Path = "models\txd"
        Sprites(191).File = "LD_POKE"
        Sprites(191).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_191.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_191.bmp").Size.Height
        Sprites(192).Name = "cd3s"
        Sprites(192).Path = "models\txd"
        Sprites(192).File = "LD_POKE"
        Sprites(192).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_192.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_192.bmp").Size.Height
        Sprites(193).Name = "cd4c"
        Sprites(193).Path = "models\txd"
        Sprites(193).File = "LD_POKE"
        Sprites(193).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_193.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_193.bmp").Size.Height
        Sprites(194).Name = "cd4d"
        Sprites(194).Path = "models\txd"
        Sprites(194).File = "LD_POKE"
        Sprites(194).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_194.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_194.bmp").Size.Height
        Sprites(195).Name = "cd4h"
        Sprites(195).Path = "models\txd"
        Sprites(195).File = "LD_POKE"
        Sprites(195).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_195.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_195.bmp").Size.Height
        Sprites(196).Name = "cd4s"
        Sprites(196).Path = "models\txd"
        Sprites(196).File = "LD_POKE"
        Sprites(196).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_196.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_196.bmp").Size.Height
        Sprites(197).Name = "cd5c"
        Sprites(197).Path = "models\txd"
        Sprites(197).File = "LD_POKE"
        Sprites(197).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_197.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_197.bmp").Size.Height
        Sprites(198).Name = "cd5d"
        Sprites(198).Path = "models\txd"
        Sprites(198).File = "LD_POKE"
        Sprites(198).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_198.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_198.bmp").Size.Height
        Sprites(199).Name = "cd5h"
        Sprites(199).Path = "models\txd"
        Sprites(199).File = "LD_POKE"
        Sprites(199).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_199.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_199.bmp").Size.Height
        Sprites(200).Name = "cd5s"
        Sprites(200).Path = "models\txd"
        Sprites(200).File = "LD_POKE"
        Sprites(200).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_200.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_200.bmp").Size.Height
        Sprites(201).Name = "cd6c"
        Sprites(201).Path = "models\txd"
        Sprites(201).File = "LD_POKE"
        Sprites(201).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_201.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_201.bmp").Size.Height
        Sprites(202).Name = "cd6d"
        Sprites(202).Path = "models\txd"
        Sprites(202).File = "LD_POKE"
        Sprites(202).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_202.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_202.bmp").Size.Height
        Sprites(203).Name = "cd6h"
        Sprites(203).Path = "models\txd"
        Sprites(203).File = "LD_POKE"
        Sprites(203).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_203.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_203.bmp").Size.Height
        Sprites(204).Name = "cd6s"
        Sprites(204).Path = "models\txd"
        Sprites(204).File = "LD_POKE"
        Sprites(204).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_204.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_204.bmp").Size.Height
        Sprites(205).Name = "cd7c"
        Sprites(205).Path = "models\txd"
        Sprites(205).File = "LD_POKE"
        Sprites(205).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_205.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_205.bmp").Size.Height
        Sprites(206).Name = "cd7d"
        Sprites(206).Path = "models\txd"
        Sprites(206).File = "LD_POKE"
        Sprites(206).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_206.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_206.bmp").Size.Height
        Sprites(207).Name = "cd7h"
        Sprites(207).Path = "models\txd"
        Sprites(207).File = "LD_POKE"
        Sprites(207).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_207.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_207.bmp").Size.Height
        Sprites(208).Name = "cd7s"
        Sprites(208).Path = "models\txd"
        Sprites(208).File = "LD_POKE"
        Sprites(208).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_208.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_208.bmp").Size.Height
        Sprites(209).Name = "cd8c"
        Sprites(209).Path = "models\txd"
        Sprites(209).File = "LD_POKE"
        Sprites(209).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_209.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_209.bmp").Size.Height
        Sprites(210).Name = "cd8d"
        Sprites(210).Path = "models\txd"
        Sprites(210).File = "LD_POKE"
        Sprites(210).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_210.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_210.bmp").Size.Height
        Sprites(211).Name = "cd8h"
        Sprites(211).Path = "models\txd"
        Sprites(211).File = "LD_POKE"
        Sprites(211).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_211.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_211.bmp").Size.Height
        Sprites(212).Name = "cd8s"
        Sprites(212).Path = "models\txd"
        Sprites(212).File = "LD_POKE"
        Sprites(212).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_212.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_212.bmp").Size.Height
        Sprites(213).Name = "cd9c"
        Sprites(213).Path = "models\txd"
        Sprites(213).File = "LD_POKE"
        Sprites(213).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_213.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_213.bmp").Size.Height
        Sprites(214).Name = "cd9d"
        Sprites(214).Path = "models\txd"
        Sprites(214).File = "LD_POKE"
        Sprites(214).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_214.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_214.bmp").Size.Height
        Sprites(215).Name = "cd9h"
        Sprites(215).Path = "models\txd"
        Sprites(215).File = "LD_POKE"
        Sprites(215).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_215.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_215.bmp").Size.Height
        Sprites(216).Name = "cd9s"
        Sprites(216).Path = "models\txd"
        Sprites(216).File = "LD_POKE"
        Sprites(216).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_216.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_216.bmp").Size.Height
        Sprites(217).Name = "cdback"
        Sprites(217).Path = "models\txd"
        Sprites(217).File = "LD_POKE"
        Sprites(217).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_217.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_217.bmp").Size.Height
        Sprites(218).Name = "deal"
        Sprites(218).Path = "models\txd"
        Sprites(218).File = "LD_POKE"
        Sprites(218).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_218.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_218.bmp").Size.Height
        Sprites(219).Name = "holdmid"
        Sprites(219).Path = "models\txd"
        Sprites(219).File = "LD_POKE"
        Sprites(219).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_219.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_219.bmp").Size.Height
        Sprites(220).Name = "holdoff"
        Sprites(220).Path = "models\txd"
        Sprites(220).File = "LD_POKE"
        Sprites(220).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_220.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_220.bmp").Size.Height
        Sprites(221).Name = "holdon"
        Sprites(221).Path = "models\txd"
        Sprites(221).File = "LD_POKE"
        Sprites(221).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_221.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_221.bmp").Size.Height
        Sprites(222).Name = "tvcorn"
        Sprites(222).Path = "models\txd"
        Sprites(222).File = "LD_POKE"
        Sprites(222).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_222.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_222.bmp").Size.Height
        Sprites(223).Name = "ball"
        Sprites(223).Path = "models\txd"
        Sprites(223).File = "LD_POOL"
        Sprites(223).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_223.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_223.bmp").Size.Height
        Sprites(224).Name = "nib"
        Sprites(224).Path = "models\txd"
        Sprites(224).File = "LD_POOL"
        Sprites(224).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_224.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_224.bmp").Size.Height
        Sprites(225).Name = "race00"
        Sprites(225).Path = "models\txd"
        Sprites(225).File = "LD_RACE"
        Sprites(225).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_225.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_225.bmp").Size.Height
        Sprites(226).Name = "race01"
        Sprites(226).Path = "models\txd"
        Sprites(226).File = "LD_RACE"
        Sprites(226).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_226.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_226.bmp").Size.Height
        Sprites(227).Name = "race02"
        Sprites(227).Path = "models\txd"
        Sprites(227).File = "LD_RACE"
        Sprites(227).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_227.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_227.bmp").Size.Height
        Sprites(228).Name = "race03"
        Sprites(228).Path = "models\txd"
        Sprites(228).File = "LD_RACE"
        Sprites(228).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_228.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_228.bmp").Size.Height
        Sprites(229).Name = "race04"
        Sprites(229).Path = "models\txd"
        Sprites(229).File = "LD_RACE"
        Sprites(229).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_229.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_229.bmp").Size.Height
        Sprites(230).Name = "race05"
        Sprites(230).Path = "models\txd"
        Sprites(230).File = "LD_RACE"
        Sprites(230).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_230.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_230.bmp").Size.Height
        Sprites(231).Name = "race06"
        Sprites(231).Path = "models\txd"
        Sprites(231).File = "LD_RACE"
        Sprites(231).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_231.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_231.bmp").Size.Height
        Sprites(232).Name = "race07"
        Sprites(232).Path = "models\txd"
        Sprites(232).File = "LD_RACE"
        Sprites(232).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_232.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_232.bmp").Size.Height
        Sprites(233).Name = "race08"
        Sprites(233).Path = "models\txd"
        Sprites(233).File = "LD_RACE"
        Sprites(233).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_233.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_233.bmp").Size.Height
        Sprites(234).Name = "race09"
        Sprites(234).Path = "models\txd"
        Sprites(234).File = "LD_RACE"
        Sprites(234).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_234.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_234.bmp").Size.Height
        Sprites(235).Name = "race10"
        Sprites(235).Path = "models\txd"
        Sprites(235).File = "LD_RACE"
        Sprites(235).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_235.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_235.bmp").Size.Height
        Sprites(236).Name = "race11"
        Sprites(236).Path = "models\txd"
        Sprites(236).File = "LD_RACE"
        Sprites(236).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_236.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_236.bmp").Size.Height
        Sprites(237).Name = "race12"
        Sprites(237).Path = "models\txd"
        Sprites(237).File = "LD_RACE"
        Sprites(237).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_237.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_237.bmp").Size.Height
        Sprites(238).Name = "race00"
        Sprites(238).Path = "models\txd"
        Sprites(238).File = "LD_RACE1"
        Sprites(238).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_238.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_238.bmp").Size.Height
        Sprites(239).Name = "race01"
        Sprites(239).Path = "models\txd"
        Sprites(239).File = "LD_RACE1"
        Sprites(239).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_239.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_239.bmp").Size.Height
        Sprites(240).Name = "race02"
        Sprites(240).Path = "models\txd"
        Sprites(240).File = "LD_RACE1"
        Sprites(240).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_240.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_240.bmp").Size.Height
        Sprites(241).Name = "race03"
        Sprites(241).Path = "models\txd"
        Sprites(241).File = "LD_RACE1"
        Sprites(241).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_241.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_241.bmp").Size.Height
        Sprites(242).Name = "race04"
        Sprites(242).Path = "models\txd"
        Sprites(242).File = "LD_RACE1"
        Sprites(242).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_242.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_242.bmp").Size.Height
        Sprites(243).Name = "race05"
        Sprites(243).Path = "models\txd"
        Sprites(243).File = "LD_RACE1"
        Sprites(243).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_243.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_243.bmp").Size.Height
        Sprites(244).Name = "race06"
        Sprites(244).Path = "models\txd"
        Sprites(244).File = "LD_RACE2"
        Sprites(244).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_244.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_244.bmp").Size.Height
        Sprites(245).Name = "race07"
        Sprites(245).Path = "models\txd"
        Sprites(245).File = "LD_RACE2"
        Sprites(245).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_245.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_245.bmp").Size.Height
        Sprites(246).Name = "race08"
        Sprites(246).Path = "models\txd"
        Sprites(246).File = "LD_RACE2"
        Sprites(246).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_246.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_246.bmp").Size.Height
        Sprites(247).Name = "race09"
        Sprites(247).Path = "models\txd"
        Sprites(247).File = "LD_RACE2"
        Sprites(247).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_247.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_247.bmp").Size.Height
        Sprites(248).Name = "race10"
        Sprites(248).Path = "models\txd"
        Sprites(248).File = "LD_RACE2"
        Sprites(248).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_248.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_248.bmp").Size.Height
        Sprites(249).Name = "race11"
        Sprites(249).Path = "models\txd"
        Sprites(249).File = "LD_RACE2"
        Sprites(249).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_249.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_249.bmp").Size.Height
        Sprites(250).Name = "race12"
        Sprites(250).Path = "models\txd"
        Sprites(250).File = "LD_RACE3"
        Sprites(250).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_250.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_250.bmp").Size.Height
        Sprites(251).Name = "race13"
        Sprites(251).Path = "models\txd"
        Sprites(251).File = "LD_RACE3"
        Sprites(251).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_251.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_251.bmp").Size.Height
        Sprites(252).Name = "race14"
        Sprites(252).Path = "models\txd"
        Sprites(252).File = "LD_RACE3"
        Sprites(252).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_252.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_252.bmp").Size.Height
        Sprites(253).Name = "race15"
        Sprites(253).Path = "models\txd"
        Sprites(253).File = "LD_RACE3"
        Sprites(253).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_253.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_253.bmp").Size.Height
        Sprites(254).Name = "race16"
        Sprites(254).Path = "models\txd"
        Sprites(254).File = "LD_RACE3"
        Sprites(254).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_254.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_254.bmp").Size.Height
        Sprites(255).Name = "race17"
        Sprites(255).Path = "models\txd"
        Sprites(255).File = "LD_RACE3"
        Sprites(255).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_255.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_255.bmp").Size.Height
        Sprites(256).Name = "race18"
        Sprites(256).Path = "models\txd"
        Sprites(256).File = "LD_RACE4"
        Sprites(256).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_256.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_256.bmp").Size.Height
        Sprites(257).Name = "race19"
        Sprites(257).Path = "models\txd"
        Sprites(257).File = "LD_RACE4"
        Sprites(257).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_257.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_257.bmp").Size.Height
        Sprites(258).Name = "race20"
        Sprites(258).Path = "models\txd"
        Sprites(258).File = "LD_RACE4"
        Sprites(258).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_258.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_258.bmp").Size.Height
        Sprites(259).Name = "race21"
        Sprites(259).Path = "models\txd"
        Sprites(259).File = "LD_RACE4"
        Sprites(259).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_259.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_259.bmp").Size.Height
        Sprites(260).Name = "race22"
        Sprites(260).Path = "models\txd"
        Sprites(260).File = "LD_RACE4"
        Sprites(260).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_260.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_260.bmp").Size.Height
        Sprites(261).Name = "race23"
        Sprites(261).Path = "models\txd"
        Sprites(261).File = "LD_RACE4"
        Sprites(261).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_261.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_261.bmp").Size.Height
        Sprites(262).Name = "race24"
        Sprites(262).Path = "models\txd"
        Sprites(262).File = "LD_RACE5"
        Sprites(262).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_262.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_262.bmp").Size.Height
        Sprites(263).Name = "roulbla"
        Sprites(263).Path = "models\txd"
        Sprites(263).File = "LD_ROUL"
        Sprites(263).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_263.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_263.bmp").Size.Height
        Sprites(264).Name = "roulgre"
        Sprites(264).Path = "models\txd"
        Sprites(264).File = "LD_ROUL"
        Sprites(264).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_264.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_264.bmp").Size.Height
        Sprites(265).Name = "roulred"
        Sprites(265).Path = "models\txd"
        Sprites(265).File = "LD_ROUL"
        Sprites(265).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_265.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_265.bmp").Size.Height
        Sprites(266).Name = "bstars"
        Sprites(266).Path = "models\txd"
        Sprites(266).File = "ld_shtr"
        Sprites(266).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_266.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_266.bmp").Size.Height
        Sprites(267).Name = "cbarl"
        Sprites(267).Path = "models\txd"
        Sprites(267).File = "ld_shtr"
        Sprites(267).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_267.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_267.bmp").Size.Height
        Sprites(268).Name = "cbarm"
        Sprites(268).Path = "models\txd"
        Sprites(268).File = "ld_shtr"
        Sprites(268).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_268.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_268.bmp").Size.Height
        Sprites(269).Name = "cbarr"
        Sprites(269).Path = "models\txd"
        Sprites(269).File = "ld_shtr"
        Sprites(269).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_269.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_269.bmp").Size.Height
        Sprites(270).Name = "ex1"
        Sprites(270).Path = "models\txd"
        Sprites(270).File = "ld_shtr"
        Sprites(270).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_270.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_270.bmp").Size.Height
        Sprites(271).Name = "ex2"
        Sprites(271).Path = "models\txd"
        Sprites(271).File = "ld_shtr"
        Sprites(271).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_271.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_271.bmp").Size.Height
        Sprites(272).Name = "ex3"
        Sprites(272).Path = "models\txd"
        Sprites(272).File = "ld_shtr"
        Sprites(272).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_272.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_272.bmp").Size.Height
        Sprites(273).Name = "ex4"
        Sprites(273).Path = "models\txd"
        Sprites(273).File = "ld_shtr"
        Sprites(273).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_273.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_273.bmp").Size.Height
        Sprites(274).Name = "fire"
        Sprites(274).Path = "models\txd"
        Sprites(274).File = "ld_shtr"
        Sprites(274).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_274.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_274.bmp").Size.Height
        Sprites(275).Name = "fstar"
        Sprites(275).Path = "models\txd"
        Sprites(275).File = "ld_shtr"
        Sprites(275).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_275.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_275.bmp").Size.Height
        Sprites(276).Name = "fstara"
        Sprites(276).Path = "models\txd"
        Sprites(276).File = "ld_shtr"
        Sprites(276).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_276.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_276.bmp").Size.Height
        Sprites(277).Name = "hbarl"
        Sprites(277).Path = "models\txd"
        Sprites(277).File = "ld_shtr"
        Sprites(277).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_277.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_277.bmp").Size.Height
        Sprites(278).Name = "hbarm"
        Sprites(278).Path = "models\txd"
        Sprites(278).File = "ld_shtr"
        Sprites(278).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_278.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_278.bmp").Size.Height
        Sprites(279).Name = "hbarr"
        Sprites(279).Path = "models\txd"
        Sprites(279).File = "ld_shtr"
        Sprites(279).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_279.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_279.bmp").Size.Height
        Sprites(280).Name = "hi_a"
        Sprites(280).Path = "models\txd"
        Sprites(280).File = "ld_shtr"
        Sprites(280).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_280.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_280.bmp").Size.Height
        Sprites(281).Name = "hi_b"
        Sprites(281).Path = "models\txd"
        Sprites(281).File = "ld_shtr"
        Sprites(281).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_281.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_281.bmp").Size.Height
        Sprites(282).Name = "hi_c"
        Sprites(282).Path = "models\txd"
        Sprites(282).File = "ld_shtr"
        Sprites(282).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_282.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_282.bmp").Size.Height
        Sprites(283).Name = "kami"
        Sprites(283).Path = "models\txd"
        Sprites(283).File = "ld_shtr"
        Sprites(283).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_283.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_283.bmp").Size.Height
        Sprites(284).Name = "nmef"
        Sprites(284).Path = "models\txd"
        Sprites(284).File = "ld_shtr"
        Sprites(284).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_284.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_284.bmp").Size.Height
        Sprites(285).Name = "pa"
        Sprites(285).Path = "models\txd"
        Sprites(285).File = "ld_shtr"
        Sprites(285).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_285.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_285.bmp").Size.Height
        Sprites(286).Name = "pm2"
        Sprites(286).Path = "models\txd"
        Sprites(286).File = "ld_shtr"
        Sprites(286).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_286.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_286.bmp").Size.Height
        Sprites(287).Name = "pm3"
        Sprites(287).Path = "models\txd"
        Sprites(287).File = "ld_shtr"
        Sprites(287).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_287.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_287.bmp").Size.Height
        Sprites(288).Name = "ps1"
        Sprites(288).Path = "models\txd"
        Sprites(288).File = "ld_shtr"
        Sprites(288).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_288.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_288.bmp").Size.Height
        Sprites(289).Name = "ps2"
        Sprites(289).Path = "models\txd"
        Sprites(289).File = "ld_shtr"
        Sprites(289).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_289.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_289.bmp").Size.Height
        Sprites(290).Name = "ps3"
        Sprites(290).Path = "models\txd"
        Sprites(290).File = "ld_shtr"
        Sprites(290).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_290.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_290.bmp").Size.Height
        Sprites(291).Name = "ship"
        Sprites(291).Path = "models\txd"
        Sprites(291).File = "ld_shtr"
        Sprites(291).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_291.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_291.bmp").Size.Height
        Sprites(292).Name = "splsh"
        Sprites(292).Path = "models\txd"
        Sprites(292).File = "ld_shtr"
        Sprites(292).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_292.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_292.bmp").Size.Height
        Sprites(293).Name = "tvcorn"
        Sprites(293).Path = "models\txd"
        Sprites(293).File = "ld_shtr"
        Sprites(293).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_293.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_293.bmp").Size.Height
        Sprites(294).Name = "tvl"
        Sprites(294).Path = "models\txd"
        Sprites(294).File = "ld_shtr"
        Sprites(294).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_294.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_294.bmp").Size.Height
        Sprites(295).Name = "tvr"
        Sprites(295).Path = "models\txd"
        Sprites(295).File = "ld_shtr"
        Sprites(295).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_295.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_295.bmp").Size.Height
        Sprites(296).Name = "ufo"
        Sprites(296).Path = "models\txd"
        Sprites(296).File = "ld_shtr"
        Sprites(296).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_296.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_296.bmp").Size.Height
        Sprites(297).Name = "un_a"
        Sprites(297).Path = "models\txd"
        Sprites(297).File = "ld_shtr"
        Sprites(297).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_297.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_297.bmp").Size.Height
        Sprites(298).Name = "un_b"
        Sprites(298).Path = "models\txd"
        Sprites(298).File = "ld_shtr"
        Sprites(298).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_298.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_298.bmp").Size.Height
        Sprites(299).Name = "un_c"
        Sprites(299).Path = "models\txd"
        Sprites(299).File = "ld_shtr"
        Sprites(299).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_299.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_299.bmp").Size.Height
        Sprites(300).Name = "bar1_o"
        Sprites(300).Path = "models\txd"
        Sprites(300).File = "LD_SLOT"
        Sprites(300).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_300.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_300.bmp").Size.Height
        Sprites(301).Name = "bar2_o"
        Sprites(301).Path = "models\txd"
        Sprites(301).File = "LD_SLOT"
        Sprites(301).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_301.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_301.bmp").Size.Height
        Sprites(302).Name = "bell"
        Sprites(302).Path = "models\txd"
        Sprites(302).File = "LD_SLOT"
        Sprites(302).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_302.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_302.bmp").Size.Height
        Sprites(303).Name = "cherry"
        Sprites(303).Path = "models\txd"
        Sprites(303).File = "LD_SLOT"
        Sprites(303).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_303.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_303.bmp").Size.Height
        Sprites(304).Name = "grapes"
        Sprites(304).Path = "models\txd"
        Sprites(304).File = "LD_SLOT"
        Sprites(304).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_304.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_304.bmp").Size.Height
        Sprites(305).Name = "r_69"
        Sprites(305).Path = "models\txd"
        Sprites(305).File = "LD_SLOT"
        Sprites(305).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_305.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_305.bmp").Size.Height
        Sprites(306).Name = "backgnd"
        Sprites(306).Path = "models\txd"
        Sprites(306).File = "LD_SPAC"
        Sprites(306).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_306.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_306.bmp").Size.Height
        Sprites(307).Name = "black"
        Sprites(307).Path = "models\txd"
        Sprites(307).File = "LD_SPAC"
        Sprites(307).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_307.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_307.bmp").Size.Height
        Sprites(308).Name = "dark"
        Sprites(308).Path = "models\txd"
        Sprites(308).File = "LD_SPAC"
        Sprites(308).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_308.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_308.bmp").Size.Height
        Sprites(309).Name = "DUALITY"
        Sprites(309).Path = "models\txd"
        Sprites(309).File = "LD_SPAC"
        Sprites(309).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_309.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_309.bmp").Size.Height
        Sprites(310).Name = "ex1"
        Sprites(310).Path = "models\txd"
        Sprites(310).File = "LD_SPAC"
        Sprites(310).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_310.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_310.bmp").Size.Height
        Sprites(311).Name = "ex2"
        Sprites(311).Path = "models\txd"
        Sprites(311).File = "LD_SPAC"
        Sprites(311).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_311.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_311.bmp").Size.Height
        Sprites(312).Name = "ex3"
        Sprites(312).Path = "models\txd"
        Sprites(312).File = "LD_SPAC"
        Sprites(312).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_312.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_312.bmp").Size.Height
        Sprites(313).Name = "ex4"
        Sprites(313).Path = "models\txd"
        Sprites(313).File = "LD_SPAC"
        Sprites(313).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_313.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_313.bmp").Size.Height
        Sprites(314).Name = "Health"
        Sprites(314).Path = "models\txd"
        Sprites(314).File = "LD_SPAC"
        Sprites(314).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_314.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_314.bmp").Size.Height
        Sprites(315).Name = "layer"
        Sprites(315).Path = "models\txd"
        Sprites(315).File = "LD_SPAC"
        Sprites(315).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_315.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_315.bmp").Size.Height
        Sprites(316).Name = "light"
        Sprites(316).Path = "models\txd"
        Sprites(316).File = "LD_SPAC"
        Sprites(316).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_316.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_316.bmp").Size.Height
        Sprites(317).Name = "power"
        Sprites(317).Path = "models\txd"
        Sprites(317).File = "LD_SPAC"
        Sprites(317).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_317.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_317.bmp").Size.Height
        Sprites(318).Name = "rockshp"
        Sprites(318).Path = "models\txd"
        Sprites(318).File = "LD_SPAC"
        Sprites(318).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_318.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_318.bmp").Size.Height
        Sprites(319).Name = "shoot"
        Sprites(319).Path = "models\txd"
        Sprites(319).File = "LD_SPAC"
        Sprites(319).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_319.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_319.bmp").Size.Height
        Sprites(320).Name = "thrustG"
        Sprites(320).Path = "models\txd"
        Sprites(320).File = "LD_SPAC"
        Sprites(320).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_320.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_320.bmp").Size.Height
        Sprites(321).Name = "tvcorn"
        Sprites(321).Path = "models\txd"
        Sprites(321).File = "LD_SPAC"
        Sprites(321).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_321.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_321.bmp").Size.Height
        Sprites(322).Name = "white"
        Sprites(322).Path = "models\txd"
        Sprites(322).File = "LD_SPAC"
        Sprites(322).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_322.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_322.bmp").Size.Height
        Sprites(323).Name = "10ls"
        Sprites(323).Path = "models\txd"
        Sprites(323).File = "LD_TATT"
        Sprites(323).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_323.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_323.bmp").Size.Height
        Sprites(324).Name = "10ls2"
        Sprites(324).Path = "models\txd"
        Sprites(324).File = "LD_TATT"
        Sprites(324).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_324.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_324.bmp").Size.Height
        Sprites(325).Name = "10ls3"
        Sprites(325).Path = "models\txd"
        Sprites(325).File = "LD_TATT"
        Sprites(325).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_325.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_325.bmp").Size.Height
        Sprites(326).Name = "10ls4"
        Sprites(326).Path = "models\txd"
        Sprites(326).File = "LD_TATT"
        Sprites(326).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_326.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_326.bmp").Size.Height
        Sprites(327).Name = "10ls5"
        Sprites(327).Path = "models\txd"
        Sprites(327).File = "LD_TATT"
        Sprites(327).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_327.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_327.bmp").Size.Height
        Sprites(328).Name = "10og"
        Sprites(328).Path = "models\txd"
        Sprites(328).File = "LD_TATT"
        Sprites(328).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_328.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_328.bmp").Size.Height
        Sprites(329).Name = "10weed"
        Sprites(329).Path = "models\txd"
        Sprites(329).File = "LD_TATT"
        Sprites(329).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_329.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_329.bmp").Size.Height
        Sprites(330).Name = "11dice"
        Sprites(330).Path = "models\txd"
        Sprites(330).File = "LD_TATT"
        Sprites(330).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_330.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_330.bmp").Size.Height
        Sprites(331).Name = "11dice2"
        Sprites(331).Path = "models\txd"
        Sprites(331).File = "LD_TATT"
        Sprites(331).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_331.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_331.bmp").Size.Height
        Sprites(332).Name = "11ggift"
        Sprites(332).Path = "models\txd"
        Sprites(332).File = "LD_TATT"
        Sprites(332).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_332.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_332.bmp").Size.Height
        Sprites(333).Name = "11grov2"
        Sprites(333).Path = "models\txd"
        Sprites(333).File = "LD_TATT"
        Sprites(333).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_333.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_333.bmp").Size.Height
        Sprites(334).Name = "11grov3"
        Sprites(334).Path = "models\txd"
        Sprites(334).File = "LD_TATT"
        Sprites(334).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_334.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_334.bmp").Size.Height
        Sprites(335).Name = "11grove"
        Sprites(335).Path = "models\txd"
        Sprites(335).File = "LD_TATT"
        Sprites(335).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_335.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_335.bmp").Size.Height
        Sprites(336).Name = "11jail"
        Sprites(336).Path = "models\txd"
        Sprites(336).File = "LD_TATT"
        Sprites(336).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_336.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_336.bmp").Size.Height
        Sprites(337).Name = "12angel"
        Sprites(337).Path = "models\txd"
        Sprites(337).File = "LD_TATT"
        Sprites(337).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_337.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_337.bmp").Size.Height
        Sprites(338).Name = "12bndit"
        Sprites(338).Path = "models\txd"
        Sprites(338).File = "LD_TATT"
        Sprites(338).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_338.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_338.bmp").Size.Height
        Sprites(339).Name = "12cross"
        Sprites(339).Path = "models\txd"
        Sprites(339).File = "LD_TATT"
        Sprites(339).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_339.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_339.bmp").Size.Height
        Sprites(340).Name = "12dager"
        Sprites(340).Path = "models\txd"
        Sprites(340).File = "LD_TATT"
        Sprites(340).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_340.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_340.bmp").Size.Height
        Sprites(341).Name = "12maybr"
        Sprites(341).Path = "models\txd"
        Sprites(341).File = "LD_TATT"
        Sprites(341).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_341.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_341.bmp").Size.Height
        Sprites(342).Name = "12myfac"
        Sprites(342).Path = "models\txd"
        Sprites(342).File = "LD_TATT"
        Sprites(342).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_342.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_342.bmp").Size.Height
        Sprites(343).Name = "4rip"
        Sprites(343).Path = "models\txd"
        Sprites(343).File = "LD_TATT"
        Sprites(343).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_343.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_343.bmp").Size.Height
        Sprites(344).Name = "4spider"
        Sprites(344).Path = "models\txd"
        Sprites(344).File = "LD_TATT"
        Sprites(344).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_344.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_344.bmp").Size.Height
        Sprites(345).Name = "4weed"
        Sprites(345).Path = "models\txd"
        Sprites(345).File = "LD_TATT"
        Sprites(345).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_345.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_345.bmp").Size.Height
        Sprites(346).Name = "5cross"
        Sprites(346).Path = "models\txd"
        Sprites(346).File = "LD_TATT"
        Sprites(346).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_346.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_346.bmp").Size.Height
        Sprites(347).Name = "5cross2"
        Sprites(347).Path = "models\txd"
        Sprites(347).File = "LD_TATT"
        Sprites(347).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_347.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_347.bmp").Size.Height
        Sprites(348).Name = "5cross3"
        Sprites(348).Path = "models\txd"
        Sprites(348).File = "LD_TATT"
        Sprites(348).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_348.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_348.bmp").Size.Height
        Sprites(349).Name = "5gun"
        Sprites(349).Path = "models\txd"
        Sprites(349).File = "LD_TATT"
        Sprites(349).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_349.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_349.bmp").Size.Height
        Sprites(350).Name = "6africa"
        Sprites(350).Path = "models\txd"
        Sprites(350).File = "LD_TATT"
        Sprites(350).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_350.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_350.bmp").Size.Height
        Sprites(351).Name = "6aztec"
        Sprites(351).Path = "models\txd"
        Sprites(351).File = "LD_TATT"
        Sprites(351).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_351.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_351.bmp").Size.Height
        Sprites(352).Name = "6clown"
        Sprites(352).Path = "models\txd"
        Sprites(352).File = "LD_TATT"
        Sprites(352).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_352.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_352.bmp").Size.Height
        Sprites(353).Name = "6crown"
        Sprites(353).Path = "models\txd"
        Sprites(353).File = "LD_TATT"
        Sprites(353).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_353.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_353.bmp").Size.Height
        Sprites(354).Name = "7cross"
        Sprites(354).Path = "models\txd"
        Sprites(354).File = "LD_TATT"
        Sprites(354).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_354.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_354.bmp").Size.Height
        Sprites(355).Name = "7cross2"
        Sprites(355).Path = "models\txd"
        Sprites(355).File = "LD_TATT"
        Sprites(355).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_355.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_355.bmp").Size.Height
        Sprites(356).Name = "7cross3"
        Sprites(356).Path = "models\txd"
        Sprites(356).File = "LD_TATT"
        Sprites(356).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_356.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_356.bmp").Size.Height
        Sprites(357).Name = "7mary"
        Sprites(357).Path = "models\txd"
        Sprites(357).File = "LD_TATT"
        Sprites(357).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_357.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_357.bmp").Size.Height
        Sprites(358).Name = "8gun"
        Sprites(358).Path = "models\txd"
        Sprites(358).File = "LD_TATT"
        Sprites(358).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_358.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_358.bmp").Size.Height
        Sprites(359).Name = "8poker"
        Sprites(359).Path = "models\txd"
        Sprites(359).File = "LD_TATT"
        Sprites(359).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_359.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_359.bmp").Size.Height
        Sprites(360).Name = "8sa"
        Sprites(360).Path = "models\txd"
        Sprites(360).File = "LD_TATT"
        Sprites(360).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_360.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_360.bmp").Size.Height
        Sprites(361).Name = "8sa2"
        Sprites(361).Path = "models\txd"
        Sprites(361).File = "LD_TATT"
        Sprites(361).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_361.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_361.bmp").Size.Height
        Sprites(362).Name = "8sa3"
        Sprites(362).Path = "models\txd"
        Sprites(362).File = "LD_TATT"
        Sprites(362).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_362.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_362.bmp").Size.Height
        Sprites(363).Name = "8santos"
        Sprites(363).Path = "models\txd"
        Sprites(363).File = "LD_TATT"
        Sprites(363).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_363.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_363.bmp").Size.Height
        Sprites(364).Name = "8westsd"
        Sprites(364).Path = "models\txd"
        Sprites(364).File = "LD_TATT"
        Sprites(364).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_364.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_364.bmp").Size.Height
        Sprites(365).Name = "9bullt"
        Sprites(365).Path = "models\txd"
        Sprites(365).File = "LD_TATT"
        Sprites(365).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_365.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_365.bmp").Size.Height
        Sprites(366).Name = "9crown"
        Sprites(366).Path = "models\txd"
        Sprites(366).File = "LD_TATT"
        Sprites(366).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_366.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_366.bmp").Size.Height
        Sprites(367).Name = "9gun"
        Sprites(367).Path = "models\txd"
        Sprites(367).File = "LD_TATT"
        Sprites(367).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_367.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_367.bmp").Size.Height
        Sprites(368).Name = "9gun2"
        Sprites(368).Path = "models\txd"
        Sprites(368).File = "LD_TATT"
        Sprites(368).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_368.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_368.bmp").Size.Height
        Sprites(369).Name = "9homby"
        Sprites(369).Path = "models\txd"
        Sprites(369).File = "LD_TATT"
        Sprites(369).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_369.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_369.bmp").Size.Height
        Sprites(370).Name = "9rasta"
        Sprites(370).Path = "models\txd"
        Sprites(370).File = "LD_TATT"
        Sprites(370).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_370.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_370.bmp").Size.Height
        Sprites(371).Name = "load0uk"
        Sprites(371).Path = "models\txd"
        Sprites(371).File = "load0uk"
        Sprites(371).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_371.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_371.bmp").Size.Height
        Sprites(372).Name = "loadsc0"
        Sprites(372).Path = "models\txd"
        Sprites(372).File = "loadsc0"
        Sprites(372).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_372.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_372.bmp").Size.Height
        Sprites(373).Name = "loadsc1"
        Sprites(373).Path = "models\txd"
        Sprites(373).File = "loadsc1"
        Sprites(373).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_373.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_373.bmp").Size.Height
        Sprites(374).Name = "loadsc10"
        Sprites(374).Path = "models\txd"
        Sprites(374).File = "loadsc10"
        Sprites(374).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_374.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_374.bmp").Size.Height
        Sprites(375).Name = "loadsc11"
        Sprites(375).Path = "models\txd"
        Sprites(375).File = "loadsc11"
        Sprites(375).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_375.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_375.bmp").Size.Height
        Sprites(376).Name = "loadsc12"
        Sprites(376).Path = "models\txd"
        Sprites(376).File = "loadsc12"
        Sprites(376).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_376.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_376.bmp").Size.Height
        Sprites(377).Name = "loadsc13"
        Sprites(377).Path = "models\txd"
        Sprites(377).File = "loadsc13"
        Sprites(377).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_377.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_377.bmp").Size.Height
        Sprites(378).Name = "loadsc14"
        Sprites(378).Path = "models\txd"
        Sprites(378).File = "loadsc14"
        Sprites(378).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_378.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_378.bmp").Size.Height
        Sprites(379).Name = "loadsc2"
        Sprites(379).Path = "models\txd"
        Sprites(379).File = "loadsc2"
        Sprites(379).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_379.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_379.bmp").Size.Height
        Sprites(380).Name = "loadsc3"
        Sprites(380).Path = "models\txd"
        Sprites(380).File = "loadsc3"
        Sprites(380).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_380.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_380.bmp").Size.Height
        Sprites(381).Name = "loadsc4"
        Sprites(381).Path = "models\txd"
        Sprites(381).File = "loadsc4"
        Sprites(381).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_381.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_381.bmp").Size.Height
        Sprites(382).Name = "loadsc5"
        Sprites(382).Path = "models\txd"
        Sprites(382).File = "loadsc5"
        Sprites(382).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_382.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_382.bmp").Size.Height
        Sprites(383).Name = "loadsc6"
        Sprites(383).Path = "models\txd"
        Sprites(383).File = "loadsc6"
        Sprites(383).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_383.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_383.bmp").Size.Height
        Sprites(384).Name = "loadsc7"
        Sprites(384).Path = "models\txd"
        Sprites(384).File = "loadsc7"
        Sprites(384).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_384.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_384.bmp").Size.Height
        Sprites(385).Name = "loadsc8"
        Sprites(385).Path = "models\txd"
        Sprites(385).File = "loadsc8"
        Sprites(385).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_385.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_385.bmp").Size.Height
        Sprites(386).Name = "loadsc9"
        Sprites(386).Path = "models\txd"
        Sprites(386).File = "loadsc9"
        Sprites(386).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_386.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_386.bmp").Size.Height
        Sprites(387).Name = "eax"
        Sprites(387).Path = "models\txd"
        Sprites(387).File = "LOADSCS"
        Sprites(387).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_387.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_387.bmp").Size.Height
        Sprites(388).Name = "loadsc0"
        Sprites(388).Path = "models\txd"
        Sprites(388).File = "LOADSCS"
        Sprites(388).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_388.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_388.bmp").Size.Height
        Sprites(389).Name = "loadsc1"
        Sprites(389).Path = "models\txd"
        Sprites(389).File = "LOADSCS"
        Sprites(389).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_389.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_389.bmp").Size.Height
        Sprites(390).Name = "loadsc10"
        Sprites(390).Path = "models\txd"
        Sprites(390).File = "LOADSCS"
        Sprites(390).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_390.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_390.bmp").Size.Height
        Sprites(391).Name = "loadsc11"
        Sprites(391).Path = "models\txd"
        Sprites(391).File = "LOADSCS"
        Sprites(391).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_391.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_391.bmp").Size.Height
        Sprites(392).Name = "loadsc12"
        Sprites(392).Path = "models\txd"
        Sprites(392).File = "LOADSCS"
        Sprites(392).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_392.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_392.bmp").Size.Height
        Sprites(393).Name = "loadsc13"
        Sprites(393).Path = "models\txd"
        Sprites(393).File = "LOADSCS"
        Sprites(393).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_393.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_393.bmp").Size.Height
        Sprites(394).Name = "loadsc14"
        Sprites(394).Path = "models\txd"
        Sprites(394).File = "LOADSCS"
        Sprites(394).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_394.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_394.bmp").Size.Height
        Sprites(395).Name = "loadsc2"
        Sprites(395).Path = "models\txd"
        Sprites(395).File = "LOADSCS"
        Sprites(395).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_395.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_395.bmp").Size.Height
        Sprites(396).Name = "loadsc3"
        Sprites(396).Path = "models\txd"
        Sprites(396).File = "LOADSCS"
        Sprites(396).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_396.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_396.bmp").Size.Height
        Sprites(397).Name = "loadsc4"
        Sprites(397).Path = "models\txd"
        Sprites(397).File = "LOADSCS"
        Sprites(397).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_397.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_397.bmp").Size.Height
        Sprites(398).Name = "loadsc5"
        Sprites(398).Path = "models\txd"
        Sprites(398).File = "LOADSCS"
        Sprites(398).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_398.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_398.bmp").Size.Height
        Sprites(399).Name = "loadsc6"
        Sprites(399).Path = "models\txd"
        Sprites(399).File = "LOADSCS"
        Sprites(399).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_399.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_399.bmp").Size.Height
        Sprites(400).Name = "loadsc7"
        Sprites(400).Path = "models\txd"
        Sprites(400).File = "LOADSCS"
        Sprites(400).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_400.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_400.bmp").Size.Height
        Sprites(401).Name = "loadsc8"
        Sprites(401).Path = "models\txd"
        Sprites(401).File = "LOADSCS"
        Sprites(401).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_401.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_401.bmp").Size.Height
        Sprites(402).Name = "loadsc9"
        Sprites(402).Path = "models\txd"
        Sprites(402).File = "LOADSCS"
        Sprites(402).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_402.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_402.bmp").Size.Height
        Sprites(403).Name = "nvidia"
        Sprites(403).Path = "models\txd"
        Sprites(403).File = "LOADSCS"
        Sprites(403).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_403.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_403.bmp").Size.Height
        Sprites(404).Name = "title_pc_EU"
        Sprites(404).Path = "models\txd"
        Sprites(404).File = "LOADSCS"
        Sprites(404).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_404.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_404.bmp").Size.Height
        Sprites(405).Name = "title_pc_US"
        Sprites(405).Path = "models\txd"
        Sprites(405).File = "LOADSCS"
        Sprites(405).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_405.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_405.bmp").Size.Height
        Sprites(406).Name = "loadsc1"
        Sprites(406).Path = "models\txd"
        Sprites(406).File = "LOADSUK"
        Sprites(406).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_406.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_406.bmp").Size.Height
        Sprites(407).Name = "loadsc10"
        Sprites(407).Path = "models\txd"
        Sprites(407).File = "LOADSUK"
        Sprites(407).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_407.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_407.bmp").Size.Height
        Sprites(408).Name = "loadsc11"
        Sprites(408).Path = "models\txd"
        Sprites(408).File = "LOADSUK"
        Sprites(408).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_408.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_408.bmp").Size.Height
        Sprites(409).Name = "loadsc12"
        Sprites(409).Path = "models\txd"
        Sprites(409).File = "LOADSUK"
        Sprites(409).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_409.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_409.bmp").Size.Height
        Sprites(410).Name = "loadsc13"
        Sprites(410).Path = "models\txd"
        Sprites(410).File = "LOADSUK"
        Sprites(410).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_410.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_410.bmp").Size.Height
        Sprites(411).Name = "loadsc14"
        Sprites(411).Path = "models\txd"
        Sprites(411).File = "LOADSUK"
        Sprites(411).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_411.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_411.bmp").Size.Height
        Sprites(412).Name = "loadsc2"
        Sprites(412).Path = "models\txd"
        Sprites(412).File = "LOADSUK"
        Sprites(412).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_412.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_412.bmp").Size.Height
        Sprites(413).Name = "loadsc3"
        Sprites(413).Path = "models\txd"
        Sprites(413).File = "LOADSUK"
        Sprites(413).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_413.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_413.bmp").Size.Height
        Sprites(414).Name = "loadsc4"
        Sprites(414).Path = "models\txd"
        Sprites(414).File = "LOADSUK"
        Sprites(414).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_414.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_414.bmp").Size.Height
        Sprites(415).Name = "loadsc5"
        Sprites(415).Path = "models\txd"
        Sprites(415).File = "LOADSUK"
        Sprites(415).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_415.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_415.bmp").Size.Height
        Sprites(416).Name = "loadsc6"
        Sprites(416).Path = "models\txd"
        Sprites(416).File = "LOADSUK"
        Sprites(416).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_416.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_416.bmp").Size.Height
        Sprites(417).Name = "loadsc7"
        Sprites(417).Path = "models\txd"
        Sprites(417).File = "LOADSUK"
        Sprites(417).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_417.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_417.bmp").Size.Height
        Sprites(418).Name = "loadsc8"
        Sprites(418).Path = "models\txd"
        Sprites(418).File = "LOADSUK"
        Sprites(418).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_418.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_418.bmp").Size.Height
        Sprites(419).Name = "loadsc9"
        Sprites(419).Path = "models\txd"
        Sprites(419).File = "LOADSUK"
        Sprites(419).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_419.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_419.bmp").Size.Height
        Sprites(420).Name = "loadscuk"
        Sprites(420).Path = "models\txd"
        Sprites(420).File = "LOADSUK"
        Sprites(420).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_420.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_420.bmp").Size.Height
        Sprites(421).Name = "bckgrnd"
        Sprites(421).Path = "models\txd"
        Sprites(421).File = "OTB"
        Sprites(421).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_421.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_421.bmp").Size.Height
        Sprites(422).Name = "blue"
        Sprites(422).Path = "models\txd"
        Sprites(422).File = "OTB"
        Sprites(422).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_422.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_422.bmp").Size.Height
        Sprites(423).Name = "bride1"
        Sprites(423).Path = "models\txd"
        Sprites(423).File = "OTB"
        Sprites(423).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_423.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_423.bmp").Size.Height
        Sprites(424).Name = "bride2"
        Sprites(424).Path = "models\txd"
        Sprites(424).File = "OTB"
        Sprites(424).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_424.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_424.bmp").Size.Height
        Sprites(425).Name = "bride3"
        Sprites(425).Path = "models\txd"
        Sprites(425).File = "OTB"
        Sprites(425).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_425.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_425.bmp").Size.Height
        Sprites(426).Name = "bride4"
        Sprites(426).Path = "models\txd"
        Sprites(426).File = "OTB"
        Sprites(426).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_426.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_426.bmp").Size.Height
        Sprites(427).Name = "bride5"
        Sprites(427).Path = "models\txd"
        Sprites(427).File = "OTB"
        Sprites(427).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_427.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_427.bmp").Size.Height
        Sprites(428).Name = "bride6"
        Sprites(428).Path = "models\txd"
        Sprites(428).File = "OTB"
        Sprites(428).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_428.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_428.bmp").Size.Height
        Sprites(429).Name = "bride7"
        Sprites(429).Path = "models\txd"
        Sprites(429).File = "OTB"
        Sprites(429).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_429.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_429.bmp").Size.Height
        Sprites(430).Name = "bride8"
        Sprites(430).Path = "models\txd"
        Sprites(430).File = "OTB"
        Sprites(430).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_430.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_430.bmp").Size.Height
        Sprites(431).Name = "bushes"
        Sprites(431).Path = "models\txd"
        Sprites(431).File = "OTB"
        Sprites(431).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_431.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_431.bmp").Size.Height
        Sprites(432).Name = "fen"
        Sprites(432).Path = "models\txd"
        Sprites(432).File = "OTB"
        Sprites(432).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_432.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_432.bmp").Size.Height
        Sprites(433).Name = "gride1"
        Sprites(433).Path = "models\txd"
        Sprites(433).File = "OTB"
        Sprites(433).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_433.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_433.bmp").Size.Height
        Sprites(434).Name = "gride2"
        Sprites(434).Path = "models\txd"
        Sprites(434).File = "OTB"
        Sprites(434).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_434.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_434.bmp").Size.Height
        Sprites(435).Name = "gride3"
        Sprites(435).Path = "models\txd"
        Sprites(435).File = "OTB"
        Sprites(435).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_435.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_435.bmp").Size.Height
        Sprites(436).Name = "gride4"
        Sprites(436).Path = "models\txd"
        Sprites(436).File = "OTB"
        Sprites(436).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_436.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_436.bmp").Size.Height
        Sprites(437).Name = "gride5"
        Sprites(437).Path = "models\txd"
        Sprites(437).File = "OTB"
        Sprites(437).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_437.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_437.bmp").Size.Height
        Sprites(438).Name = "gride6"
        Sprites(438).Path = "models\txd"
        Sprites(438).File = "OTB"
        Sprites(438).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_438.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_438.bmp").Size.Height
        Sprites(439).Name = "gride7"
        Sprites(439).Path = "models\txd"
        Sprites(439).File = "OTB"
        Sprites(439).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_439.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_439.bmp").Size.Height
        Sprites(440).Name = "gride8"
        Sprites(440).Path = "models\txd"
        Sprites(440).File = "OTB"
        Sprites(440).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_440.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_440.bmp").Size.Height
        Sprites(441).Name = "hrs1"
        Sprites(441).Path = "models\txd"
        Sprites(441).File = "OTB"
        Sprites(441).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_441.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_441.bmp").Size.Height
        Sprites(442).Name = "hrs2"
        Sprites(442).Path = "models\txd"
        Sprites(442).File = "OTB"
        Sprites(442).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_442.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_442.bmp").Size.Height
        Sprites(443).Name = "hrs3"
        Sprites(443).Path = "models\txd"
        Sprites(443).File = "OTB"
        Sprites(443).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_443.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_443.bmp").Size.Height
        Sprites(444).Name = "hrs4"
        Sprites(444).Path = "models\txd"
        Sprites(444).File = "OTB"
        Sprites(444).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_444.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_444.bmp").Size.Height
        Sprites(445).Name = "hrs5"
        Sprites(445).Path = "models\txd"
        Sprites(445).File = "OTB"
        Sprites(445).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_445.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_445.bmp").Size.Height
        Sprites(446).Name = "hrs6"
        Sprites(446).Path = "models\txd"
        Sprites(446).File = "OTB"
        Sprites(446).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_446.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_446.bmp").Size.Height
        Sprites(447).Name = "hrs7"
        Sprites(447).Path = "models\txd"
        Sprites(447).File = "OTB"
        Sprites(447).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_447.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_447.bmp").Size.Height
        Sprites(448).Name = "hrs8"
        Sprites(448).Path = "models\txd"
        Sprites(448).File = "OTB"
        Sprites(448).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_448.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_448.bmp").Size.Height
        Sprites(449).Name = "pole2"
        Sprites(449).Path = "models\txd"
        Sprites(449).File = "OTB"
        Sprites(449).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_449.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_449.bmp").Size.Height
        Sprites(450).Name = "pride1"
        Sprites(450).Path = "models\txd"
        Sprites(450).File = "OTB"
        Sprites(450).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_450.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_450.bmp").Size.Height
        Sprites(451).Name = "pride2"
        Sprites(451).Path = "models\txd"
        Sprites(451).File = "OTB"
        Sprites(451).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_451.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_451.bmp").Size.Height
        Sprites(452).Name = "pride3"
        Sprites(452).Path = "models\txd"
        Sprites(452).File = "OTB"
        Sprites(452).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_452.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_452.bmp").Size.Height
        Sprites(453).Name = "pride4"
        Sprites(453).Path = "models\txd"
        Sprites(453).File = "OTB"
        Sprites(453).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_453.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_453.bmp").Size.Height
        Sprites(454).Name = "pride5"
        Sprites(454).Path = "models\txd"
        Sprites(454).File = "OTB"
        Sprites(454).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_454.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_454.bmp").Size.Height
        Sprites(455).Name = "pride6"
        Sprites(455).Path = "models\txd"
        Sprites(455).File = "OTB"
        Sprites(455).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_455.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_455.bmp").Size.Height
        Sprites(456).Name = "pride7"
        Sprites(456).Path = "models\txd"
        Sprites(456).File = "OTB"
        Sprites(456).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_456.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_456.bmp").Size.Height
        Sprites(457).Name = "pride8"
        Sprites(457).Path = "models\txd"
        Sprites(457).File = "OTB"
        Sprites(457).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_457.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_457.bmp").Size.Height
        Sprites(458).Name = "rride1"
        Sprites(458).Path = "models\txd"
        Sprites(458).File = "OTB"
        Sprites(458).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_458.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_458.bmp").Size.Height
        Sprites(459).Name = "rride2"
        Sprites(459).Path = "models\txd"
        Sprites(459).File = "OTB"
        Sprites(459).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_459.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_459.bmp").Size.Height
        Sprites(460).Name = "rride3"
        Sprites(460).Path = "models\txd"
        Sprites(460).File = "OTB"
        Sprites(460).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_460.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_460.bmp").Size.Height
        Sprites(461).Name = "rride4"
        Sprites(461).Path = "models\txd"
        Sprites(461).File = "OTB"
        Sprites(461).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_461.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_461.bmp").Size.Height
        Sprites(462).Name = "rride5"
        Sprites(462).Path = "models\txd"
        Sprites(462).File = "OTB"
        Sprites(462).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_462.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_462.bmp").Size.Height
        Sprites(463).Name = "rride6"
        Sprites(463).Path = "models\txd"
        Sprites(463).File = "OTB"
        Sprites(463).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_463.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_463.bmp").Size.Height
        Sprites(464).Name = "rride7"
        Sprites(464).Path = "models\txd"
        Sprites(464).File = "OTB"
        Sprites(464).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_464.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_464.bmp").Size.Height
        Sprites(465).Name = "rride8"
        Sprites(465).Path = "models\txd"
        Sprites(465).File = "OTB"
        Sprites(465).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_465.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_465.bmp").Size.Height
        Sprites(466).Name = "trees"
        Sprites(466).Path = "models\txd"
        Sprites(466).File = "OTB"
        Sprites(466).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_466.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_466.bmp").Size.Height
        Sprites(467).Name = "tvcorn"
        Sprites(467).Path = "models\txd"
        Sprites(467).File = "OTB"
        Sprites(467).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_467.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_467.bmp").Size.Height
        Sprites(468).Name = "tvl"
        Sprites(468).Path = "models\txd"
        Sprites(468).File = "OTB"
        Sprites(468).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_468.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_468.bmp").Size.Height
        Sprites(469).Name = "tvr"
        Sprites(469).Path = "models\txd"
        Sprites(469).File = "OTB"
        Sprites(469).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_469.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_469.bmp").Size.Height
        Sprites(470).Name = "yride1"
        Sprites(470).Path = "models\txd"
        Sprites(470).File = "OTB"
        Sprites(470).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_470.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_470.bmp").Size.Height
        Sprites(471).Name = "yride2"
        Sprites(471).Path = "models\txd"
        Sprites(471).File = "OTB"
        Sprites(471).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_471.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_471.bmp").Size.Height
        Sprites(472).Name = "yride3"
        Sprites(472).Path = "models\txd"
        Sprites(472).File = "OTB"
        Sprites(472).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_472.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_472.bmp").Size.Height
        Sprites(473).Name = "yride4"
        Sprites(473).Path = "models\txd"
        Sprites(473).File = "OTB"
        Sprites(473).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_473.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_473.bmp").Size.Height
        Sprites(474).Name = "yride5"
        Sprites(474).Path = "models\txd"
        Sprites(474).File = "OTB"
        Sprites(474).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_474.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_474.bmp").Size.Height
        Sprites(475).Name = "yride6"
        Sprites(475).Path = "models\txd"
        Sprites(475).File = "OTB"
        Sprites(475).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_475.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_475.bmp").Size.Height
        Sprites(476).Name = "yride7"
        Sprites(476).Path = "models\txd"
        Sprites(476).File = "OTB"
        Sprites(476).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_476.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_476.bmp").Size.Height
        Sprites(477).Name = "yride8"
        Sprites(477).Path = "models\txd"
        Sprites(477).File = "OTB"
        Sprites(477).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_477.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_477.bmp").Size.Height
        Sprites(478).Name = "backbet"
        Sprites(478).Path = "models\txd"
        Sprites(478).File = "OTB2"
        Sprites(478).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_478.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_478.bmp").Size.Height
        Sprites(479).Name = "butnA"
        Sprites(479).Path = "models\txd"
        Sprites(479).File = "OTB2"
        Sprites(479).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_479.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_479.bmp").Size.Height
        Sprites(480).Name = "butnAo"
        Sprites(480).Path = "models\txd"
        Sprites(480).File = "OTB2"
        Sprites(480).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_480.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_480.bmp").Size.Height
        Sprites(481).Name = "butnB"
        Sprites(481).Path = "models\txd"
        Sprites(481).File = "OTB2"
        Sprites(481).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_481.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_481.bmp").Size.Height
        Sprites(482).Name = "butnBo"
        Sprites(482).Path = "models\txd"
        Sprites(482).File = "OTB2"
        Sprites(482).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_482.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_482.bmp").Size.Height
        Sprites(483).Name = "butnC"
        Sprites(483).Path = "models\txd"
        Sprites(483).File = "OTB2"
        Sprites(483).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_483.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_483.bmp").Size.Height
        Sprites(484).Name = "Ric1"
        Sprites(484).Path = "models\txd"
        Sprites(484).File = "OTB2"
        Sprites(484).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_484.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_484.bmp").Size.Height
        Sprites(485).Name = "Ric2"
        Sprites(485).Path = "models\txd"
        Sprites(485).File = "OTB2"
        Sprites(485).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_485.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_485.bmp").Size.Height
        Sprites(486).Name = "Ric3"
        Sprites(486).Path = "models\txd"
        Sprites(486).File = "OTB2"
        Sprites(486).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_486.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_486.bmp").Size.Height
        Sprites(487).Name = "Ric4"
        Sprites(487).Path = "models\txd"
        Sprites(487).File = "OTB2"
        Sprites(487).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_487.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_487.bmp").Size.Height
        Sprites(488).Name = "Ric5"
        Sprites(488).Path = "models\txd"
        Sprites(488).File = "OTB2"
        Sprites(488).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_488.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_488.bmp").Size.Height
        Sprites(489).Name = "outro"
        Sprites(489).Path = "models\txd"
        Sprites(489).File = "outro"
        Sprites(489).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_489.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_489.bmp").Size.Height
        Sprites(490).Name = "splash1"
        Sprites(490).Path = "models\txd"
        Sprites(490).File = "splash1"
        Sprites(490).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_490.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_490.bmp").Size.Height
        Sprites(491).Name = "splash2"
        Sprites(491).Path = "models\txd"
        Sprites(491).File = "splash2"
        Sprites(491).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_491.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_491.bmp").Size.Height
        Sprites(492).Name = "gtasamapbit1"
        Sprites(492).Path = "samaps"
        Sprites(492).File = "samaps"
        Sprites(492).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_492.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_492.bmp").Size.Height
        Sprites(493).Name = "gtasamapbit2"
        Sprites(493).Path = "samaps"
        Sprites(493).File = "samaps"
        Sprites(493).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_493.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_493.bmp").Size.Height
        Sprites(494).Name = "gtasamapbit3"
        Sprites(494).Path = "samaps"
        Sprites(494).File = "samaps"
        Sprites(494).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_494.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_494.bmp").Size.Height
        Sprites(495).Name = "gtasamapbit4"
        Sprites(495).Path = "samaps"
        Sprites(495).File = "samaps"
        Sprites(495).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_495.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_495.bmp").Size.Height
        Sprites(496).Name = "map"
        Sprites(496).Path = "samaps"
        Sprites(496).File = "samaps"
        Sprites(496).Size = Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_496.bmp").Size.Width & "x" & Image.FromFile(My.Application.Info.DirectoryPath & "\Resources\Sprite_496.bmp").Size.Height
    End Sub
