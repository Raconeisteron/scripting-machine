...
#End Region
    ...
    Private Sub OpenToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripMenuItem.Click
        ...
        For Each path In OFD.FileNames
            If File.Exists(path) Then
                Dim name As String
                name = Mid(path, path.LastIndexOf("\") + 2, path.LastIndexOf(".") - path.LastIndexOf("\") - 1)
                Instances.Add(New Instance(name))
                With Instances(GetInstanceByName(name))
...
#Region "Build"
    ...
    Private Sub BuildToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BuildToolStripMenuItem1.Click
        ...
        For Each pr As Process In Process.GetProcesses
            ...
            End If
        Next
        Dim path As String = Mid(Instances(TabControl1.SelectedIndex).Path, 1, Instances(TabControl1.SelectedIndex).Path.LastIndexOf("\") + 1) & Instances(TabControl1.SelectedIndex).Name & ".xml"
...
#Region "Helper hiding"

    Private Sub TreeView1_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TreeView1.LostFocus
        Helper.Visible = False
    End Sub

    Private Sub TreeView2_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TreeView2.LostFocus
        Helper.Visible = False
    End Sub
